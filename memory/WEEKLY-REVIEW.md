...
| Metric | Value |
|--------|-------|
| Starting portfolio | $10,289.08 (Aug 14 EOD) |
| Ending portfolio | $10,323.32 (Aug 21 EOD; live `account.equity` $10,322.13 — $1.19 post-close mark drift, snapshot basis authoritative) |
| Week return | **+$34.24 (+0.333%)** |
| S&P 500 week | **-1.37%** (SPY $776.34 Aug 14 → $765.72 Aug 21, Alpaca bars) — the worst SPY week of the phase, and the first negative one since Jul 10 |
| Bot vs S&P | **+1.70pp** (endpoint arithmetic) |
| Alpha vs SPX (v3) | **+1.68pp** — `metrics.py rollup --since 2026-08-17`, the source of record. **The best alpha week of the phase**, and the first to clear +1pp. The 0.02pp gap to the endpoint figure is daily-sum vs endpoint compounding, not a data disagreement. Decomposition: **cash drag +0.34pp / selection +1.34pp** — for the first time in the phase the cash sleeve was an *asset*, because the tape fell |
| Core/Satellite P&L (v3) | core **+$17.36** / satellite **+$17.01** |
| Trades | 2 (W:1 / L:2 / open:4) |
| Win rate | 0% on full closes (0/2); **33.3%** (1/3) counting the XLV scale-out slice |
| Best trade | XLV scale-out slice **+7.91%** (+$25.60) |
| Worst trade | XLI **-1.11%** (-$22.35) |
| Profit factor | **0.90** (gains $25.60 / losses $28.47; net realized **-$2.87**) |
| daytrade_count | **0 (source=local, derived — field absent from the paper `/account` payload) [conservative: 3]**; delta vs prior week **0 -> 0**, no change. 86 trading days / **17 consecutive weeks at zero day trades** |

**Metrics completeness:** `memory/METRICS.jsonl` carries all 5 sessions of the week (Aug 17–21) with no gaps. Nothing in this entry is hand-assembled; no figure is marked `incomplete`.

**Benchmark provenance:** `prior_close` $776.34 (Aug 14) is read from last week's entry as recorded, not re-queried — Alpaca's `adjustment=all` mutates historical closes retroactively, and the cached read is what keeps the alpha series comparable. `last_close` $765.72 (Aug 21) from this week's `bars SPY 1Day 10`. No prior week's benchmark figure has been revised. *Footnote on intraday-vs-final marks:* the daily METRICS rows recorded SPY at $769.10 (Aug 19) and $762.78 (Aug 20) against the settled bars $769.06 and $762.60 — differences of 4c and 18c, taken at snapshot time before the final print. They affect no weekly figure (the week is computed endpoint-to-endpoint from settled bars) and are noted rather than corrected in place.

### Closed Trades
| Ticker | Entry | Exit | P&L | Notes |
| ------ | ----- | ---- | --- | ----- |
| XLV (partial) | $161.92 (2026-07-31) | $174.72 (2026-08-19, 2 of 6 sh) | **+$25.60 (+7.906%)** | **Rule 8 profit ladder, first scale-out since Jul 09.** Crossed the +7 etf rung at +7.85% unrealized (hwm-gain +9.06%); trail tightened 7% → 5% in the same cancel/sell/re-place sequence, Rule 9 cushion 4.99% > 3% ✓ |
| FERG | $245.30 (2026-08-13) | $244.28 (2026-08-19, 6 sh) | **-$6.12 (-0.416%)** | **Rule 16 decay-chain rotation.** Flagged Aug 18, confirmed Aug 19; below entry AND lagging SPY 10-session by 4.22pp. Melt-up guard inapplicable (SPY ret10 +0.02%). Six sessions held, cut at 0.4% rather than letting a -4.2% relative slide compound into the 10% trail |
| XLI | $182.4618 blended (2026-05-13 / 08-03 / 08-11) | $180.43 (2026-08-20, 11 sh) | **-$22.35 (-1.114%)** | **Rule 16 decay-chain rotation — the first core ETF ever rotated by the rule.** Flagged Aug 19, confirmed Aug 20; -1.11% below entry, lagging SPY 10-session by 2.01pp. Melt-up guard inspected and correctly declined (SPY ret10 -0.32%, a down tape). Exited 6.1% above where the 10% trail sat |

### Open Positions at Week End
| Ticker | Entry | Close | Unrealized | Stop | Tier |
| ------ | ----- | ----- | ---------- | ---- | ---- |
| XLB | $50.08 (2026-05-18) | $53.54 | +$138.40 (+6.91%) | $51.02925 (**5% trail**, GTC b6cec1cf, hwm $53.715) | core |
| XLRE | $44.79 (2026-07-13) | $45.08 | +$13.34 (+0.65%) | $41.8095 (10% trail, GTC 16d5a6b2, hwm $46.455) | core |
| XLV | $169.7473 blended (2026-07-31 / **08-20 add**) | $174.64 | +$53.82 (+2.88%) | $158.04 (10%, GTC 60dcfc62, 7 sh, hwm $175.60) + $167.22375 (**5%**, GTC bd3edce1, 4 sh, hwm $176.025) | core |
| GILD | $144.3136 (2026-08-21) | $146.22 | +$20.97 (+1.32%) | $131.598 (10% trail, GTC e9c7b266, hwm $146.22 — placed today, Rule 13) | **satellite** |

daytrade_count: **0 (source=local — derived, field absent from the paper `/account` payload) [conservative: 3]**. Positions **4/6**, two slots free and, for the first time in nine sessions, **fundable** ($2,578.58 cash). **ETF core $6,135.32 = 79.20% of deployed** ≥45% floor ✓. **Satellite sleeve 1/3.** Deployment **75.02%** — back inside the 75–85% band by 2 basis points. Sector spread of deployed: **Health Care 45.68%** (XLV 24.83% + GILD 20.85%) / Materials 27.65% / Real Estate 26.79% — all ≤50% ✓, but Health Care is **the tightest single-sector concentration of the phase**, a deliberate two-instrument bet taken with eyes open; ≤2 satellites/sector ✓ (1). Position weights vs equity: XLB **20.73%** and XLRE **20.10%** sit *through* the Rule 3 20% cap **on appreciation, not on entry** — not a breach, but neither may absorb a share; XLV 18.61%, GILD 15.57%. **All 4 names carry armed GTC trailing stops across 5 orders** (verified in `orders open`: GILD 11/11, XLV 4+7 = 11/11, XLB 40/40, XLRE 46/46); zero unprotected names, zero orphan orders after three cancellations this week.

### Go-live scorecard (v3.4)

```
Go-live scorecard — TRIAL WINDOW 2026-08-06..2026-08-21 (12 sessions). Verdict: FAIL.
Weekly scorecard (2026-08-17..2026-08-21, informational only): PASS.
```

**`--since "$TRIAL_START"` (2026-08-06, resolved by fallback — `trial_start:` still reads `UNSET`) — the go/no-go verdict:**

| Criterion | Result | Detail |
|---|---|---|
| `cadence` | **PASS** | 48/48 routine slots |
| `rule14_tokens` | **PASS** | 24/24 Rule 14 audit tokens |
| `rule14_accuracy` | **FAIL** | inaccurate on `['2026-08-07']` |
| `unprotected` | **PASS** | zero unprotected positions |
| `breaches` | **PASS** | zero money-moving rule breaches |
| `rule16_meltup` | **FAIL** | 2 shallow melt-up rotations |
...
`alpha_informational` (**NOT a gate**): cum_alpha **+0.86pp** / cash_drag **+0.10pp** / selection **+0.76pp** over 12 sessions — the trial window turned **positive on alpha for the first time**, having read -0.82pp a week ago.

**Weekly window (2026-08-17..2026-08-21), informational progress read: `PASS` on all seven.** `cadence` 20/20 · `rule14_tokens` 10/10 · `rule14_accuracy` PASS · `unprotected` PASS · `breaches` PASS · `rule16_meltup` PASS (0 shallow rotations) · **`deployment` PASS** — the first week of the trial in which the deployment criterion has passed, and the first full 7/7 weekly scorecard of the phase. `alpha_informational`: **+1.68pp** / drag +0.34pp / selection +1.34pp.

**The two verdicts disagree, and every point of the disagreement is dated before Aug 10.** All three trial-window failures are inherited, none is new, and none originates in this week:
- `rule14_accuracy` and `rule16_meltup` FAIL on **2026-08-07 alone** — the deliberately defective seed pair that predates both v3.4 fixes. Identical to last week's finding.
- `deployment` FAILs on the **Aug 11 three-session run**, which is now nine sessions old. **This week's below-floor run was exactly 2 consecutive sessions (Aug 19 66.91%, Aug 20 59.29%), restored Aug 21 to 75.02%** — at the criterion limit, not over it, and deliberately closed before the Friday boundary so it cannot straddle into next week and score twice.

**This is the fourth consecutive review to record that `trial_start: UNSET` is what holds the go-live verdict at FAIL**, and the divergence is now unambiguous: **every criterion passes on every session from Aug 10 onward.** The verdict stands as computed — the criteria are not being edited to fit the result — but it is no longer measuring the bot. It is measuring one unedited line in `PROJECT-CONTEXT.md`.

**`deployment` diagnostics — `rule5_triggers` vs `rule5_acted`, side by side** (reported although the weekly criterion PASSed, because the mechanism still has not completed a restore):

| Window | `rule5_triggers` | `rule5_acted` |
|---|---|---|
| Week (Aug 17–21) | **1** (Aug 21) | **0** |
| Trial (Aug 06–21) | **4** | **1** |

**Rule 5 has now armed four times across the trial and completed zero restores.** This week it armed on Friday after the Aug 19/20 below-floor pair and `acted=false` — and the band was restored anyway, by GILD entering at the **unrelaxed 2:1 satellite floor**. That is the second consecutive week in which the band was restored by an ordinary discretionary entry rather than by the ballast mechanism (Aug 20's XLV add did the same at a full 2:1). The trigger arms, the grace period expires unused, and an ordinary trade does the work. **This is a benign outcome and a broken mechanism at the same time**, and the distinction matters: `triggers 1 / acted 0` here is *not* the melt-up RS hole — the screens admitted a name, it just did not need the relaxation.

### What Worked
- **The strategy's best week of the phase, and it was earned on the down side of the tape.** SPY fell **-1.37%**, its worst week of the phase; the book rose **+0.33%**. **+1.68pp of alpha, the first week above +1pp**, and the decomposition says why in a way no prior week could: **selection +1.34pp** against a cash drag that was for once *positive* (+0.34pp). Six consecutive positive-alpha days, widening into Friday's +0.48pp. The low-beta core that cost -0.52pp into a strong Thursday tape last week is the same book that paid this week — that is the design working in the direction it was designed for.
- **Rule 16 rotated a core ETF for the first time in the phase, and it was right within one session.** XLI was cut Aug 20 at $180.43, -1.11% below entry and 2.01pp behind SPY on ten sessions; SPY then fell a further 0.4% into Friday and the freed $1,984.73 was redeployed into GILD, which closed **+1.32%** on day one. The rule cut at -1.11% rather than waiting for the 10% trail sitting 6.1% lower. **Both of the week's full closes were Rule 16 rotations and both exited inside 1.2% of entry** — the third and fourth consecutive rotations to do so (BIIB, XLF, FERG, XLI). A 0% win rate on full closes looks bad in the table and is the rule performing exactly as specified: momentum decay is cut small, before it becomes a loss worth recording.
- **The Rule 8 ladder fired for the first time since Jul 09, and the sequencing was handled correctly.** XLV crossed the +7 etf rung at +7.85%; the routine could not use a bare `replace-stop` because the old GTC trail reserved all 6 shares (`qty_available: 0`), so it cancelled, sold the 2-share slice at **+7.906% (+$25.60)**, then placed a fresh 5% trail over the remaining 4 — and **verified the net protection improved**: the new 5% stop sits $1.76 *above* what the old 7% trail carried, despite the hwm reset. That is the W16 hwm-reset defect being reasoned around explicitly instead of tripping over.
- **The capital famine broke, and both ends of the band were navigated inside three sessions.** The book went 84.5% (Mon/Tue, no headroom) → 66.9% (Wed, after the FERG rotation and XLV trim freed $1,815) → 59.4% (Thu, after the XLI rotation) → **75.02% (Fri)**. Two entries, two exits, and the band restored on the last session of the week — deliberately, so the below-floor run stopped at 2 and could not straddle the Friday boundary into a criterion failure. **This is the first week the book has moved capital in both directions with intent.**
- **A fourth consecutive flawless operational week, and the first full 7/7 weekly scorecard.** Rule 18 cadence **20/20**; Rule 14 tokens **10/10** with zero session gaps on the explicit sweep; **zero unprotected positions on all five EODs** including two sessions with real Rule 13 work owed (XLV's 7 new shares Aug 20, GILD's 11 Aug 21, both armed at the 15:00 CT bell so neither could fire same-day); zero money-moving breaches; zero Rule 14 aborts; **86 trading days / 17 weeks at zero day trades**. Rule 15 held XLV read-only on Aug 20 — the day it mattered, since the blended lot carried a same-day buy and a midday sell would have been the phase's first genuine day trade. Attribution reconciled to equity within **$0.13**.
- **The satellite sleeve outperformed the core per-capital and broke the two-week under-performance streak.** +$17.01 on ~$905 of average capital against core's +$17.36 on ~$6,685 — the sleeve produced half the week's P&L on 12% of the capital. FERG's rotation cost -0.42% and GILD's entry returned +1.32% in a single session.

### What Didn't Work
- **Rule 5 armed and did nothing, for the fourth time in the trial, and has still never completed a restore.** The mechanism was proposed in W14, elevated in W15, shipped for W16, and across twelve trial sessions reads **4 triggers / 1 act / 0 completed restores**. This week the arming was harmless — GILD restored the band at the full 2:1 floor and the relaxation was never needed — but "harmless because something else did the job" is not evidence the mechanism works. **Two consecutive weeks now, the band has been restored by a discretionary entry while the ballast trigger sat armed and idle.** The W16 sizing-floor proposal is carried forward unchanged and is now the oldest unaddressed mechanical finding in the log.
- **Rule 16 branch 1 (the ETF sector-quadrant exit) has now been evaluated on seventeen consecutive middays and never once exercised, and it still has no operational definition.** It bit harder this week than in any prior: **XLB's RS50 flipped negative on Friday (-0.09pp)** on the book's largest position (20.73% of equity), with one vendor calling Materials extremely overbought and the copper backwardation that underwrote the whole move cracking **$545 → $248**. The refusal was again correct and again rested on prose — `rscreen` is a buy-side entry screen and reading its `pass=0` as an exit would invent a rule the strategy does not contain, while Rule 16's numeric gate returns `flag=0` on a position **+6.90% above entry whose own 10-session return beats SPY by 2.16pp**. Both readings point the same way today. **They will not always.** Branch 1 is also the only path that can override the melt-up guard, so an undefined test sits on the sell side of the most important guard in the rulebook — the same missing-detector shape that let the Rule 14 fail-open survive fourteen weeks. **Flagged as the #1 item by four separate sessions this week alone.**
- **Both full closes were losses and the profit factor came in below 1.00 (0.90) on net realized -$2.87.** This is the correct reading of a week whose *unrealized* book gained: the exit rules produced two small losses by design and the ladder produced one gain, so the realized table understates a week in which equity made a new phase high. It is worth stating plainly rather than explaining away — **the realized ledger has now been net-negative in two of the last three weeks**, and a strategy that only ever books small losses on exits depends entirely on the held book to compound.
- **Health Care is 45.68% of deployed across two instruments, the tightest sector concentration of the phase.** XLV (24.83%) and GILD (20.85%) are a deliberate two-instrument bet and both were taken on genuine RS leadership, but a single Health Care shock now moves nearly half the deployed book. Compounding it: **Industrials is armed for a Rule 10 sector-kill** (FERG -$6.12 → XLI -$22.35, back-to-back losses with no winner between) and **Consumer Staples remains armed** from June/July — so two of the eleven sector sleeves are closed to new entries just as the book needs somewhere other than Health Care to put its $2,578.58 of cash.
- **`trial_start:` is still `UNSET`, for a fourth consecutive review, and the go-live verdict is now measuring paperwork rather than performance.** Every criterion passes on every session from Aug 10 onward; the FAIL is carried entirely by the Aug 6/7 seed pair and a nine-session-old deployment run. **The bot cannot fix this and cannot trade its way out of it.**
- **`TRADING_MODE` ran unset for a twenty-second consecutive session.** The default is correct and every routine verified it against the endpoint, but the mode guard exists to catch a *half-done* live switch and it cannot compare a mode that was never set. On Aug 20 the unset default carried a real $1,219.54 order. Carried for a fourth week.

### Key Lessons
- **A defensive book's value is only measurable on the days the market falls, and this was the first such week of the phase.** Sixteen weeks of reviews recorded low-beta drag into rising tapes — -0.52pp on a single Thursday last week alone. One down week returned **+1.68pp**, more than the entire cumulative alpha deficit the trial had accrued, and flipped the trial-window `alpha_informational` from -0.82pp to **+0.86pp**. **The cost of the design was being paid in visible increments and the benefit arrived in one lump.** That asymmetry is worth remembering the next time a strong-tape week produces a review paragraph about drag.
- **A 0% win rate can be the exit rules working perfectly.** Both full closes were Rule 16 rotations, both cut inside 1.2% of entry, and both preceded further weakness. The metric that matters for a momentum-decay rule is not win rate but **loss size at exit** — four consecutive rotations now (BIIB, XLF, FERG, XLI) have exited within 1.2% of entry, against 10% trails sitting 6pp lower. **Report both, and never let the win-rate column drive a change to a rule that is designed to be frequently, cheaply wrong.**
- **A mechanism that is never needed and a mechanism that does not work look identical from the outside.** Rule 5 has armed 4× and restored the band 0×, and on both of the last two occasions an ordinary discretionary entry restored it first. The only way to tell "correctly idle" from "structurally unable" is the instrumentation — `rule5_triggers` vs `rule5_acted` alongside the sizing clamp reason — which is why the diagnostic is reported even in a week the criterion PASSed. **A passing criterion is not a reason to stop looking at the mechanism underneath it.**
- **The band was closed on Friday on purpose, and that is a real strategic act, not bookkeeping.** Two sessions below the floor is the criterion limit; a third would have failed it, and a run straddling the Friday boundary would have scored 2-and-2 across two weekly windows while failing the trial window — the exact seam the two-window rule exists to catch. **Knowing the measurement boundary changed the trade timing, and it changed it in the direction the rule wants.**
- **Seventeen middays of correct discretion on Branch 1 is seventeen coin flips that happened to land the same way.** Every refusal was defensible and Friday's was vindicated within hours. But XLB now sits at 20.73% of equity with a negative RS50 and a cracked commodity thesis, and the next session that faces this test has no rule to consult. **The record of always deciding correctly is not evidence the test is defined; it is evidence the test has not yet been hard.**
- **Execution discipline remains solved, for a 17th week.** 86 sessions, zero day trades, zero unprotected positions, zero money-moving breaches, four consecutive weeks of perfect cadence and audit tokens, and the first 7/7 weekly scorecard. Every open item in this review is a definition, a one-line config change, or a sizing interaction — **none of it is execution.**

**Satellite-sleeve check (v3 spec):** W15 sat +1.59% / core +2.25% → **sat UNDER**; W16 sat -0.15% / core +0.22% → **sat UNDER**; **W17 sat +$17.01 on ~$905 average capital (+1.88%, or +1.11% on capital-when-occupied) / core +$17.36 on ~$6,685 (+0.26%) → sat OVER.** The under-performance streak **breaks at 2** — the 3+ week shrink-sat trigger is **NOT met**, and this week the signal points firmly the other way: the sleeve produced **half the week's P&L on 12% of the capital** and remains **under-utilised at 1/3**. **No shrink-sat proposal.**

### Adjustments for Next Week
- **Monday Aug 24 opens in-band at 75.02% with $2,578.58 cash and two free position slots — the most usable capacity the book has had in the phase.** Deployment sits **2 basis points** above the floor, so any drawdown at all re-opens the Rule 5 question on session 1. The constraint next week is neither capital nor conviction but **where**: Industrials and Consumer Staples are closed by Rule 10, and Health Care is already at 45.68% of deployed.
- **XLB is the position to watch and has been flagged by four consecutive sessions.** Largest holding at 20.73% of equity, **+6.90% above entry**, RS50 flipped negative Friday (-0.09pp), one vendor calling Materials extremely overbought, and the copper backwardation behind the move down from $545 to $248. Rule 16's numeric gate says hold (above entry, 10-session return beats SPY by 2.16pp) and Rule 8's +7 rung is reached but un-actionable (`target_trail_pct: 5` against a live 5% trail — not strictly less, no-tighten, eighth consecutive session). **If XLB rolls over, Branch 1's missing definition stops being academic on the same day.**
- **XLV is the nearest capital-freeing catalyst.** Aged 4-share leg at hwm $176.025 and the 7-share leg at hwm $175.60; the blended $169.7473 entry puts the position 0.30pp short of the +4 etf rung. A modest advance arms the next scale-out.
- **GILD reaches T+2 Tuesday and is fully actionable from Monday's midday** — Rule 7 at -7%, Rule 16 flag-eligible the moment it is below entry *and* lagging. Entered on a beat-and-raise with next earnings **Oct 29, ten weeks out**, so no binary sits inside the holding window. Its 10-session RS was +10.39pp at entry; the decay leg is nowhere near.
- **Watch Health Care concentration before adding anything.** XLV + GILD = 45.68% of deployed against a 50% cap — a third Health Care idea is effectively blocked, and the satellite sleeve already carries 1 of its ≤2 per sector there.
- **Rule 3 drift is now an eleven-session standing condition.** XLB 20.73% and XLRE 20.10% are through the cap on appreciation; neither can absorb a share, and the pre-market must not propose an add to either.
- **No auto-applied strategy mutations** (DECIDED G). See proposed changes below.

### Overall Grade: A-

**The best week the strategy has had, on the worst week the market has had.** SPY -1.37%, the book +0.33%, **alpha +1.68pp** — the first week above +1pp, the sixth consecutive positive-alpha day, and enough on its own to flip the trial window's cumulative alpha from -0.82pp to **+0.86pp**. The decomposition finally shows the design paying for itself: **+1.34pp of selection with cash drag turning positive at +0.34pp**, which is the mirror image of every prior week's complaint. The **first full 7/7 weekly scorecard of the trial**, including the first-ever `deployment` PASS — earned deliberately, by restoring the band on Friday so the below-floor run stopped at two sessions and could not straddle the boundary. Rule 16 rotated a core ETF for the first time and was vindicated within a session; the Rule 8 ladder fired for the first time in six weeks and the awkward cancel/sell/re-place sequencing was handled with the net protection verified rather than assumed; the satellite sleeve produced half the week's P&L on 12% of the capital. Process was immaculate for a fourth straight week — **20/20 cadence, 10/10 audit tokens, zero unprotected positions across two sessions with real Rule 13 work, zero breaches, 86 sessions at zero day trades**, attribution reconciled to **$0.13**.

What holds it below an A is that **the two oldest structural findings both got worse, not better**. Rule 5 armed for a fourth time and completed its zeroth restore — the band was rescued by a discretionary entry for the second consecutive week, which makes the mechanism look fine precisely because it is never the thing that acts. And **Branch 1 reached its seventeenth undefined midday on the session its hardest test arrived**: XLB, the book's largest position at 20.73% of equity, flipped RS50 negative with its commodity thesis cracking, and the hold was decided on prose. Add a realized ledger at **profit factor 0.90** and a Health Care sleeve at 45.68% of deployed with two sectors Rule-10-closed, and the risks are concentrating even as the returns arrive. The go-live verdict remains **FAIL** on nobody's trading decision: `trial_start` is still `UNSET` for a fourth review, every criterion passes on every session from Aug 10 on, and one unedited line is now the only thing between this trial and a decidable verdict.

## Proposed strategy changes (NOT auto-applied — human review required)

- **`memory/PROJECT-CONTEXT.md` (proposed change): set `trial_start: 2026-08-10`.** Replace the literal `UNSET` on line 43 with the first trading day on which all five routine prompts were running v3.4 text. **Carried unchanged for a second week; escalating to the top of the list.**
- **Rationale:** While the line reads `UNSET` the go-live scorecard falls back to the earliest METRICS.jsonl row and permanently includes the 2026-08-06/07 seed pair, which predates both v3.4 fixes and fails `rule14_accuracy` and `rule16_meltup` by construction. The trial has now produced **a full 7/7 weekly PASS** and every criterion passes on every session from Aug 10 onward — the verdict is FAIL solely on two pre-fix sessions and one nine-session-old deployment run.
- **Evidence:** This week's two scorecards side by side: trial window (2026-08-06..) FAILs `rule14_accuracy` on `['2026-08-07']`, `rule16_meltup` on 2 shallow rotations both dated Aug 7, and `deployment` on the Aug 11 run; the weekly window (2026-08-17..) PASSes all seven. `PROJECT-CONTEXT.md` lines 41–52 predicted this outcome in writing before the data existed.
- **Conviction: HIGH — and it is now the single blocking item for the go-live decision.** One-line human edit, zero trading-behaviour change. **Verify before applying:** Aug 10 is correct only if the v3.4 re-paste was complete before that Monday's pre-market; if any routine still ran v3.3 text that day, set it to the first session that did not.

- **Rule 16 branch 1 (proposed change): give the ETF sector-quadrant exit an operational definition, or remove it.** Suggested test unchanged from W16: rotate a core ETF when its **RS50 vs SPY is negative for 3 consecutive sessions AND its close is below a falling 50-DMA** — both legs absolute-ish, neither satisfiable by one day's noise. If no definition is agreed, delete the branch and let the decay chain plus the melt-up guard govern ETF exits alone. **Carried from W16; the evidence strengthened materially this week.**
- **Rationale:** Seventeen consecutive middays evaluated, zero exercised, every one a written judgement call. It is the **only path that can override the melt-up guard**. This week it faced its sharpest test yet on the book's largest position: **XLB flipped RS50 negative (-0.09pp) on Friday** at 20.73% of equity, with Materials flagged extremely overbought and the copper backwardation underwriting the thesis collapsing $545 → $248. The refusal was correct on Rule 16's numeric gate (XLB +6.90% above entry, 10-session return beating SPY by 2.16pp) and correct on principle (`rscreen` is a buy-side screen; `pass=0` is not an exit signal) — but neither argument appears in the rulebook, and the two will eventually disagree.
- **Evidence:** TRADE-LOG middays 2026-08-17 through 2026-08-21; 2026-08-20 ("sixteenth consecutive midday… now the top standing item for Friday's review"); 2026-08-21 ("seventeenth consecutive midday… XLB is the sharpened candidate and was again refused deliberately"); Friday's pre-market naming XLB "the position most likely to be the next Rule 16 or Rule 8 event".
- **Conviction: HIGH on the need, MEDIUM on the specific thresholds.** The thresholds are a starting point for review, not a measured optimum; the non-negotiable part is that the branch stops being adjudicated by prose.

- **Rule 3 / position-sizing floor (proposed change): let a Rule 5 ballast restore be sized to the *restore budget* rather than to the standard minimum clip.** When the trigger is armed and `restore_dollars` is smaller than the 5%-of-equity minimum position, permit a `tier: core` **add to an existing holding** at exactly `restore_dollars`, bypassing the minimum-clip floor (which exists to prevent uneconomically small *new* positions, not to block a top-up of a name already held). Adds remain subject to the Rule 3 20% cap and the 85% ceiling. **Carried unchanged from W16.**
- **Rationale:** Rule 5 has now armed **4 times across the trial and completed 0 restores**. On both of the last two occasions the band was restored by an ordinary discretionary entry at the full 2:1 floor while the trigger sat armed and idle — which makes the mechanism *look* fine and leaves it untested. The residual is a sizing interaction (Rule 3's cap clamping from above, the minimum clip exceeding the restore budget from below), not an R:R threshold, so no further loosening of the R:R floor is proposed.
- **Evidence:** `metrics.py rollup --since 2026-08-06` → `rule5_triggers: 4, rule5_acted: 1`; `--since 2026-08-17` → `rule5_triggers: 1, rule5_acted: 0` with the band restored the same session by GILD at an unrelaxed 2:1; TRADE-LOG 2026-08-20 market-open ("the grace period expired unused because an ordinary 2:1 entry did the job first"); the W16 Aug 12–13 rows where a ~$485 restore budget met a ~$514 minimum clip.
- **Conviction: HIGH.** Narrowly scoped (armed-trigger only, core only, existing holdings only, all other caps intact) and it addresses the only mechanical finding that has survived four consecutive reviews.

- **`replace-stop` hwm handling (proposed change): carry the existing high-water mark forward through a trail-percentage change instead of resetting it to the current price.** If the broker cannot preserve hwm on replacement, record the pre-replacement hwm in the STOP UPDATE row and have Rule 8 read hwm-gain from the logged peak rather than the live order field. **Carried from W16, with one mitigating data point.**
- **Rationale:** The defect recurred this week on XLV's Aug 19 ladder tighten (7% → 5%), and the routine handled it **correctly and explicitly** — it verified the new 5% stop sat $1.76 *above* what the old 7%/hwm-$176.59 trail carried, so protection improved despite the reset. That is the good case. The forward-looking risk is unchanged: on a position trading well below a much higher prior peak, a tighten would *lower* the effective stop despite a smaller trail percentage, and Rule 9's check on `stop_price` at replacement time would not necessarily catch it. XLB's older reset (Aug 11, $53.595 → $53.085) also finally cleared this week when the tape made a new high at $53.715.
- **Evidence:** TRADE-LOG 2026-08-19 STOP UPDATE (XLV hwm reset with the net-protection check written out); 2026-08-11 STOP UPDATE (XLB, the original); 2026-08-21 midday (XLB hwm $53.715, above the pre-reset $53.595 — the five-session rung denial resolved by price, not by fix).
- **Conviction: MEDIUM.** Downgraded from MEDIUM-HIGH: the realized cost has now fully unwound and the one live recurrence was caught by explicit reasoning. The latent Rule 9 bypass remains, so the item stays open rather than being retired.

- **Operational (proposed change): set `TRADING_MODE=paper` explicitly in the routine UI.** Twenty-two consecutive sessions on the unset default. The default is correct and every routine's mode guard verified it against the endpoint on every session, but the guard exists to catch a half-done live switch and cannot compare a mode that was never set against an endpoint that was. On Aug 20 the unset default carried a real $1,219.54 order. **Free, changes nothing, prerequisite before any live switch. Carried for a fourth week.**

- **Health Care concentration (new, informational — no rule change proposed):** XLV + GILD = **45.68% of deployed** against the 50% sector cap, the tightest single-sector reading of the phase, at the same moment **Industrials is armed for a Rule 10 kill** (FERG → XLI, back-to-back losses) and **Consumer Staples remains armed** from Jun/Jul. Both entries were individually correct on RS leadership and both cleared every gate; the concentration is an emergent consequence of two sectors being closed, not of a gate failing. **No change proposed** — the existing 50% cap is doing its job and would block a third name — but next week's pre-market should treat Health Care as effectively full and look elsewhere first.

- **Rule 16 melt-up guard (W15 proposal) — SHIPPED and VINDICATED, retired last week; still clean.** `shallow_rotations` = 0 for a second consecutive week. The guard was inspected on both of this week's rotations and correctly declined to engage — FERG (SPY ret10 +0.02%) and XLI (SPY ret10 -0.32%), both far below the +3.0% threshold, i.e. a flat-to-down tape, not a melt-up. Correct non-firing is the result being reported; no action.
...
| Metric | Value |
|--------|-------|
| Starting portfolio | $10,241.37 (Aug 28 EOD) |
| Ending portfolio | $10,254.03 (Sep 4 EOD; live `account.equity` at review time $10,230.69 — **$23.34** post-close mark drift, the largest of the phase and ~14× the usual $1–2; snapshot basis authoritative per STEP 1) |
| Week return | **+$12.66 (+0.124%)** |
| S&P 500 week | **+0.11%** (SPY $769.35 Aug 28 → $770.19 Sep 4, Alpaca bars) |
| Bot vs S&P | **+0.01pp** (endpoint arithmetic: +0.124% − 0.109% = +0.015pp) |
| Alpha vs SPX (v3) | **+0.01pp (headline)** — `metrics.py rollup --since 2026-08-31` returns `cum_alpha_pp +0.0088`, the source of record; the 0.006pp gap to the endpoint figure is daily-sum vs endpoint compounding, not a data disagreement. **First non-negative week since W17 and the flattest read of the phase.** Series: W13 +0.85 / W14 -3.21 / W15 -2.00 / W16 -0.27 / W17 +1.68 / W18 -1.27 → **W19 +0.01**. **Decomposition (rollup): cash drag +0.11pp / selection -0.10pp** — the two legs cancel almost exactly, and *both signs are inverted from every prior week*: the idle cash **helped** and the held book **hurt**. Read Sep 3 and Sep 4 together for the mechanism — the book gave up **-1.11pp** on a +1.04% melt-up and recovered **+0.04pp** on a -0.39% fade. A book that lags a rising tape and matches a falling one is an under-deployed book, not a mis-selected one, which is the deployment finding below stated in alpha terms |
| Core/Satellite P&L (v3) | core **-$61.13** / satellite **+$73.93** — week-contribution basis (mark-to-market Aug 28 close → Sep 4 close, entries from fill, exits to fill). Core: XLRE **-$27.14** (46sh, $44.48 → $43.89 exit), XLE **-$20.00** (25sh from the $64.79 fill), XLB **-$19.71** (27sh, $53.18 → $52.45), XLV **+$5.72**. Satellite: GILD **+$62.43** (11sh, $145.32 → $150.995), MPC **+$21.88** (2sh from the $377.96 fill), CRWD **-$10.38** (6sh, $218.30 → $216.57 exit). Sum **+$12.80** vs the +$12.66 snapshot delta — **14c**, mark-rounding. **Per capital (session-weighted): core -1.30% vs satellite +3.00%** |
| Trades | 2 buys (MPC, XLE) — (W:0 / L:2 / open:5). 2 full closes, **neither routine-initiated as a market order**: XLRE by Rule 16 decay-chain rotation, CRWD by its own trailing stop |
| Win rate | **0%** (0/2 full closes). No partial scale-outs this week, so unlike W17/W18 there is no slice to soften the figure |
| Best trade | **CRWD -0.70%** (-$9.12) — there were no realized winners; the "best" close is the least bad |
| Worst trade | **XLRE -2.01%** (-$41.40) |
| Profit factor | **0.00** (gains $0.00 / losses $50.52; net realized **-$50.52**). Phase-to-date realized ledger degrades from 1.44 to **1.15** |
| daytrade_count | **0 (source=local, derived — field absent from the paper `/account` payload) [conservative: 2]**; delta vs prior week **0 -> 0 (source=local) [conservative: 2]**, no change. 96 trading days / **19 consecutive weeks at zero day trades** |

**Metrics completeness:** `memory/METRICS.jsonl` carries all 5 sessions of the week (Aug 31 – Sep 4) with no gaps. Nothing in this entry is hand-assembled; no figure is marked `incomplete`.

**Benchmark provenance:** `prior_close` $769.35 (Aug 28) is read from last week's entry as recorded, not re-queried — Alpaca's `adjustment=all` mutates historical closes retroactively, and the cached read is what keeps the alpha series comparable. It agrees to the cent with this week's bars pull. `last_close` $770.19 (Sep 4) from this week's `bars SPY 1Day 10`. **No prior week's benchmark figure has been revised.** *(Minor, noted not corrected: the Aug 31 METRICS row recorded SPY at $767.02 against the settled bar $767.05 — 3c, taken at snapshot time before the final print. The week is computed endpoint-to-endpoint from settled bars, so it affects no figure here.)*

**Rule 14 audit-token sweep (v3.3):** `grep -c 'Rule 14 DTC:'` over the Aug 31 – Sep 4 rows returns **10**, against an expected `2 × 5 trading sessions = 10`. Session by session, both tokens present: Aug 31 (market-open ✓ / midday ✓) · Sep 1 ✓/✓ · Sep 2 ✓/✓ · Sep 3 ✓/✓ · Sep 4 ✓/✓. **Zero Rule 14 audit gaps.** Independent verification: per-date `alpaca.sh activities` across the five business days returns fills on three days only — Aug 31 XLRE **sell** 46 · Sep 1 CRWD **sell** 5+1 and MPC **buy** 2 (**different symbols**) · Sep 2 XLE **buy** 25; Sep 3 and Sep 4 zero fills. **Zero symbols with a same-day buy+sell pair**, so the true round-trip count is 0 and every logged token of 0 is accurate. `DTC_CONSERVATIVE` (raw sell-only count over the window) = **2** (XLRE Aug 31, CRWD Sep 1), up from 1 last week — logged, never gating.

### Closed Trades
| Ticker | Entry | Exit | P&L | Notes |
| ------ | ----- | ---- | --- | ----- |
| XLRE | $44.79 (2026-07-13) | $43.89 (2026-08-31, 46 sh) | **-$41.40 (-2.01%)** | **Rule 16 momentum-decay rotation — the first decay-chain exit of the phase.** Second consecutive flag: below entry (-1.98%) **and** lagging SPY by 1.15pp over 10 sessions, with the melt-up guard verified disengaged (SPY 10d -0.91%, nowhere near the +3.0% ceiling), so this is a real relative-weakness read and not a suppressed one. Standing 10% trail `16d5a6b2` cancelled to free `qty_available` for the close. **The rule worked exactly as designed and the position still cost -$41.40** — which is the honest read: Rule 16 is a laggard-rotation mechanism, not a loss-avoidance one |
| CRWD | $218.09 (2026-08-28) | $216.57 (2026-09-01, 6 sh) | **-$9.12 (-0.697%)** | **Closed by its own trailing stop, autonomously — not a routine-initiated sell.** Rule 8's Aug 31 tighten (10% → 7%, on a +7.23% hwm read) converted a +5.14% Monday close into a small realized loss when the name reversed **-4.99%** in one session on Tuesday. Held **two sessions**. No DTC impact — opened Aug 28, so not a same-day round trip |

### Open Positions at Week End
| Ticker | Entry | Close | Unrealized | Stop | Tier |
| ------ | ----- | ----- | ---------- | ---- | ---- |
| XLB | $50.08 (2026-05-18) | $52.45 | +$63.99 (+4.73%) | $51.5942 (**4.1% trail**, GTC b4d2de76, hwm $53.80) — **1.63% of room, the thinnest of the phase** | core |
| XLV | $169.7473 blended (2026-07-31 / 08-20 add) | $171.68 | +$21.26 (+1.14%) | $158.238 (10%, GTC 60dcfc62, 7 sh, hwm $175.82) + $167.22375 (**5%**, GTC bd3edce1, 4 sh, hwm $176.025) | core |
| XLE | $64.79 (2026-09-02) | $63.99 | **-$20.00 (-1.24%)** | $58.968 (10% trail, GTC be71317b, hwm $65.52) | core |
| GILD | $144.3136 (2026-08-21) | $150.995 | +$73.50 (+4.63%) | $137.286 (10% trail, GTC e9c7b266, hwm $152.54) | **satellite** |
| MPC | $377.96 (2026-09-01) | $388.90 | +$21.88 (+2.89%) | $358.67214 (10% trail, GTC 7318b7c5, hwm $398.5246) | **satellite** |

daytrade_count: **0 (source=local — derived, field absent from the paper `/account` payload) [conservative: 2]**. Positions **5/6**, one slot free. **ETF core $4,904.38 = 66.79% of deployed** ≥45% floor ✓. **Satellite sleeve 2/3** (GILD, MPC), **≤2 per sector ✓** (Health Care 1, Energy 1). **Deployment 71.61% — a fifth consecutive session below the 75% floor and the whole week outside the band** (see Rule violations). Sector spread of deployed: **Health Care 48.34%** (XLV 25.72% + GILD 22.62%) — under the Rule 12 50% cap for a third session, resolved Sep 2 by dilution rather than a forced sell; Energy **32.38%** (XLE 21.75% + MPC 10.63%), Materials 19.29%; all ≤50% ✓. Position weights vs equity: XLV **18.34%** (largest), GILD 16.06%, XLE 15.59%, XLB 13.80%, MPC 7.58% — all inside the Rule 3 20% cap with 1.7pp of margin. **All 5 names carry armed GTC trailing stops across 6 orders covering 76 / 76 held shares** — zero unprotected names, **twenty-third consecutive EOD at zero**, zero orphan orders. Cash **$2,910.90**; headroom to the 85% ceiling **$1,372.80** = 2.68 minimum clips.

### Go-live scorecard (v3.4)

```
Go-live scorecard — TRIAL WINDOW 2026-08-06..2026-09-04 (22 sessions). Verdict: FAIL.
Weekly scorecard (2026-08-31..2026-09-04, informational only): FAIL.
```

`--since "$TRIAL_START"`, where `TRIAL_START` resolved to **2026-08-06** — `PROJECT-CONTEXT.md` line 43 still reads the literal `trial_start: UNSET`, which is a sentinel and not a date, so resolution fell through to `min(date)` over `METRICS.jsonl`. **Sixth consecutive review on the fallback.**

| Criterion | Result | Detail |
|---|---|---|
| `cadence` | **PASS** | 88/88 routine slots |
| `rule14_tokens` | **PASS** | 44/44 Rule 14 audit tokens |
| `rule14_accuracy` | **FAIL** | inaccurate on `['2026-08-07']` — a pre-fix seed session, unchanged for six weeks |
| `unprotected` | **PASS** | zero unprotected positions |
| `breaches` | **PASS** | zero money-moving rule breaches |
| `rule16_meltup` | **FAIL** | 2 shallow melt-up rotations, both dated 2026-08-07, both predating the guard |
| `deployment` | **FAIL** | 2026-08-11: 3 consecutive sessions below the 75.0% floor — **and now a second, longer run this week** |

**The weekly verdict is a FAIL this week, and that is the material change.** For two consecutive reviews the weekly scorecard returned 7/7 PASS while the trial window failed only on Aug 7 / Aug 11 seed-session artefacts, and each review said so. **That is no longer the shape of the result.** This week's weekly scorecard fails `deployment` on `2026-09-02: 3 consecutive sessions below the 75.0% floor` — a run that happened *this week*, on current code, with every v3.4 fix in place. Six of seven criteria still pass on every session from Aug 10 onward; the seventh no longer does.

Weekly criteria detail: `cadence` 20/20 · `rule14_tokens` 10/10 · `rule14_accuracy` all accurate · `unprotected` zero · `breaches` zero · `rule16_meltup` 0 shallow rotations · **`deployment` FAIL**.

**`deployment` diagnostics (v3.4):** week `rule5_triggers: 3, rule5_acted: 1`; trial window `rule5_triggers: 8, rule5_acted: 2`. This is the **`triggers > 0, acted == 0`-adjacent** reading — the relaxation armed on three of five sessions and acted once, and the one action (XLE, Sep 2, admitted at the relaxed 1.5:1 core floor) **did not restore the band**: `restore_dollars` was $1,952.26 against a maximum admissible clip of $1,621.00, so the fill closed 83% of the gap and left the trigger armed. Market-open said so in advance, which is why it is recorded as arithmetic and not a miss. **The remaining three sessions are the real finding: `restore_dollars` fell to $356.26, below the $510.93 5%-of-equity minimum clip, so Rule 5 became *structurally unactionable* — armed, correct, and unable to spend the rump without overshooting the very band it exists to restore.** Four consecutive sessions in that state. Neither reading changes the verdict; both point at the same fix, which is the standing Rule 3 / restore-sizing proposal below, now upgraded to the top item.

**A note the criteria themselves earn.** The v3.4 spec removed the `rule5.triggered` reset from `deployment` precisely so that a window where the relaxation arms and the screens admit nothing would **FAIL**, and stated that this is the intended verdict. That is exactly what happened this week, and the criterion caught it. **The criteria are not being edited** — this is the design working, and the correct response is to fix the sizing interaction, not the bar.

`alpha_informational` (trial window, **not a gate**): `cum_alpha_pp -0.3978`, `cum_cash_drag_pp +0.0314`, `cum_selection_alpha_pp -0.4292`. Essentially unchanged from last week's -0.4066 — a flat week moves a 22-session cumulative by 0.01pp, which is the mirror of last week's demonstration that one bad week moves it by 1.3pp. **Note the trial-level sign flip: cumulative cash drag has crossed to *positive* (+0.03pp) for the first time**, so on the whole trial the idle cash is no longer a net cost and the entire cumulative miss is now selection (-0.43pp).

**Satellite-sleeve check (v3):** **no proposal owed, and the gap is now wide.** Per-capital, the satellite sleeve **outperformed** core for a third consecutive week and by the largest margin of the phase — core **-1.30%** on ~$4,700 of session-weighted capital, satellite **+3.00%** on ~$2,466. Three-week attribution: W17 core +$17.36 / sat +$17.01 (satellite **over**, on 12% of the capital), W18 core -$73.26 / sat -$8.64 (satellite **over**), W19 core -$61.13 / sat **+$73.93** (satellite **over**, and the only sleeve in profit). **The 3-consecutive-week underperformance condition the check exists to catch is not met and has never been met.** See the core-sleeve note under proposed changes: the run the log is actually tracking is the *opposite* one, and it reached three weeks today.

### What Worked
- **The satellite sleeve carried the entire week.** +$73.93 against a core sleeve at -$61.13, on roughly half the capital. GILD alone (+$62.43, +4.63% unrealized) is more than the week's whole P&L, and MPC (+$21.88, +2.89% in four sessions) is the second-best contributor. Both are single-stock satellites — the sleeve the v3 design treats as the risky half.
- **Rule 16 fired for the first time in the phase, on the right name, for the right reason.** XLRE's decay chain completed on Aug 31: below entry, lagging SPY by 1.15pp over 10 sessions, second consecutive flag, melt-up guard verified disengaged at SPY 10d -0.91%. The mechanism the W15 review shipped and the W16–W18 reviews could only argue about in prose finally executed, and the log shows the arithmetic rather than a judgement.
- **The XLE entry was the one time Rule 5 actually acted** — `rule5.acted: true` for only the second time across 22 trial sessions, at the relaxed 1.5:1 core floor, on a name that passed every other gate and moved the book from 55.75% to 71.73% deployed in one session. It also resolved the six-session Rule 12 Health Care breach passively, by growing the denominator instead of selling anything.
- **Process held under strain: 20/20 cadence, 10/10 audit tokens, 23 consecutive sessions at zero unprotected positions, zero money-moving breaches, attribution reconciled to 14 cents.** Two entries and two exits in a week and not one of them touched a rule edge.
- **Midday recomputed rather than inherited on Sep 4, and it mattered.** Pre-market and market-open both forecast XLE as a Rule 16 candidate on an RS10 of -0.02pp. Midday's own spec-fixed window (`bars 1Day 11`) returned **+0.90% vs SPY +0.63%** — XLE **ahead** by 0.26pp, not behind — and traced the divergence to a one-session base shift in the pre-market's 200-bar pull. A flag that would have opened a rotation chain on the largest core position was correctly not raised.

### What Didn't Work
- **The whole week was outside the deployment band — five sessions, the longest sub-floor run of the phase — and it broke the weekly scorecard's two-week PASS streak.** This is the first weekly criterion failure that is about current behaviour rather than an Aug-7 seed artefact, and it is the finding of the review.
- **Rule 5 is armed and structurally unactionable, four sessions running.** Once `restore_dollars` fell to $356.26 against a $510.93 minimum clip, the mechanism could not act at all: any admissible position overshoots the band it is restoring. The trigger is correct, the R:R floor relaxation is correct, and the sizing floor makes both inert. **This is now a four-day-old diagnosis with no routine-level fix — it is a rulebook question and it is the top proposal below.**
- **0% win rate on full closes, and no scale-out to soften it.** Both exits were losses (-$50.52 realized), and neither was a decision this bot made on the day — XLRE left by a rule, CRWD left by its own stop. Profit factor 0.00; the phase realized ledger falls 1.44 → 1.15.
- **The CRWD round trip is the week's clearest self-inflicted wound.** Rule 8 tightened the trail 10% → 7% on Aug 31 off a +7.23% **hwm** read while the current-price gain was +4.15%. One -4.99% session later the tighter stop took the position out at -0.70%, two sessions after entry. A 10% trail would have held it. **The hwm-driven tighten is doing real work in the wrong direction on a fast satellite**, and this is the first time the ladder has cost money rather than banked it.
- **XLB's 4.1% trail is now the most dangerous object in the book.** 1.63% of room against Friday's close, down from 3.04% on Wednesday, and **barely half of Rule 9's own 3% no-stop-within-3%-of-price floor**. Rule 9 forbids loosening it and the ladder's only available target (5%) *is* looser, so the position is structurally locked into a trail the rulebook would never newly place. Flagged for a sixth consecutive session. A 1.6% Materials down-move takes out the book's third-largest position and a +4.73% gain.
- **The R:R gate shut the book on Thursday and Friday with everything else clear.** Friday in particular: calendar clear for the first time in four sessions, $1,378 of headroom, core floor clear, weekly cap unbound, a slot free — and the best of four screen-surviving candidates (XLF, at a *fresh 200-session closing high*) returned **1.11:1** against the relaxed 1.5:1 floor. **Week 19 used 2 of 5 buy slots; the weekly cap has still never bound in this phase.**
- **The core sleeve underperformed the satellite sleeve for a third consecutive week**, and this time it was not close: -1.30% vs +3.00% per capital.

### Key Lessons
- **A gate that is correct and inert is still a failure.** Rule 5 armed on three of five sessions, held the right diagnosis every time, and could act on one — and on that one it could not restore the band because the admissible clip was smaller than the gap. The v3.4 `deployment` criterion was written to fail exactly this and it did. **The lesson is that arming is not acting, and the scorecard is the only thing in the system that refuses to accept the distinction.**
- **The hwm-driven ladder tighten has a satellite problem.** On a slow ETF, tightening off the high-water mark banks gains. On a name that moves 5% in a session, it converts an open winner into a realized loser: CRWD was +5.14% on Monday's close, tightened to 7% on a +7.23% hwm read, and stopped out at -0.70% on Tuesday. The current-price gain was only +4.15% — **the ladder acted on a peak the position was already 3pp below.**
- **Three weeks of per-capital attribution now say the core sleeve is where the alpha leaks, and this week says it emphatically.** The v3 design's stated worry was that single-stock satellites would be the risk. Every week since W17 has falsified it. The sleeve that is hardest to refresh (core, because a 10% stop against a sector ETF's realistic target rarely clears the R:R floor) is the sleeve that is losing.
- **Under-deployment is now visible directly in the alpha decomposition, not just in the deployment number.** -1.11pp on a +1.04% up day, +0.04pp on a -0.39% down day. That asymmetry *is* the 28% cash pile, and no amount of selection skill fixes it.

### Adjustments for Next Week
- **Deployment is the week's first job.** Five sessions below the floor, $1,372.80 of headroom to the ceiling, 2.68 minimum clips available, one position slot and three unused weekly buy slots. Monday's `SESSIONS_BELOW_BAND` reads **5** and Rule 5 arms again with `restore_dollars` ≈ $356 — below the minimum clip, so **expect a fifth armed-and-inert session unless the rulebook changes**.
- **XLB's stop will likely resolve itself.** 1.63% of room. If it fires, it fires at +~4.7% and frees ~$1,400 into a book that needs deployment — that is not the worst outcome available, and it should not be pre-empted (Rule 9 forbids loosening it in any case).
- **XLE is the watch item.** Only red name (-1.24%), satisfies Rule 16's first clause for a second session, and cleared the benchmark clause by **0.26pp** — a margin that can flip on Monday's first bar. Let the numeric branch decide; do not argue it in prose.
- **GILD and MPC both sit ~0.3–0.6pp under the +6 stock rung on hwm reads and are hwm-locked** — neither can fire without a *new* high. Given the CRWD lesson, if either does trigger, the tighten deserves a second look before it is placed.
- **Health Care is at 48.34% of deployed** — buyable but with only ~1.7pp of Rule 12 room; Industrials remains Rule-10 closed. Materials, Financials, Info Tech and broad-market core names are the open lanes.
- **No auto-applied strategy mutations** (DECIDED G). See proposed changes below.

### Overall Grade: B-

**The bot matched the index in a week where it did almost everything right and one thing structurally wrong.** +0.124% against SPY's +0.109% is **+0.01pp of alpha** — the flattest week of the phase, the first non-negative one since W17, and a 1.28pp improvement on last week. Rule 16 executed its first real rotation. Rule 5 acted for only the second time in 22 sessions. Midday caught a false decay flag by recomputing instead of inheriting. Process was clean for a sixth straight week: 20/20 cadence, 10/10 tokens, 23 consecutive sessions at zero unprotected positions, zero breaches, attribution reconciled to **fourteen cents**.

What holds it to B- is that **the weekly scorecard failed for the first time in three weeks, on a criterion measuring this week.** Deployment sat below the 75% floor on all five sessions — the longest sub-floor run of the phase — and the mechanism built to fix that was armed on three of them and able to act on one. The realized ledger is **0 for 2, -$50.52, profit factor 0.00**, and one of those losses (CRWD) was manufactured by our own ladder tightening a trail off a high-water mark the position was already 3pp below. The alpha decomposition confirms the diagnosis in the plainest available terms: **-1.11pp on a melt-up, +0.04pp on a fade.** That is an under-deployed book, and it is the same complaint the log has been carrying since W14 — except that this week, for the first time, the scorecard says so too instead of passing it through.

The go-live verdict remains **FAIL**, but the reason has changed and that matters more than the verdict. For five reviews every failure was dated Aug 7 or Aug 11 and the honest summary was "nothing that happened this week." **That sentence is no longer true.** `trial_start` has read `UNSET` for a sixth review, and the seed-session artefacts are still there — but they are no longer the only thing failing.

## Proposed strategy changes (NOT auto-applied — human review required)

- **Rule 3 / position-sizing floor (proposed change): let a Rule 5 ballast restore be sized to the *restore budget* rather than to the standard minimum clip. PROMOTED TO TOP ITEM.** When the trigger is armed and `restore_dollars` is smaller than the 5%-of-equity minimum position, permit a `tier: core` **add to an existing holding** at exactly `restore_dollars`, bypassing the minimum-clip floor. Adds remain subject to the Rule 3 20% cap and the 85% ceiling. **Carried unchanged from W16/W17/W18 — this week it became the binding constraint rather than a theoretical one.**
- **Rationale:** Rule 5 has now armed **8 times across the trial and completed 2 restores**. On **four consecutive sessions this week** (Sep 1–4) it was armed with `restore_dollars` **$356.26** against a **$510.93** minimum clip — mathematically unable to act, because every admissible position overshoots the band it exists to restore. This is not an R:R threshold problem and not a missed run; it is a sizing interaction, and it is now the direct cause of a **weekly-scorecard `deployment` FAIL**.
- **Evidence:** `metrics.py rollup --since 2026-08-31` → `rule5_triggers: 3, rule5_acted: 1`; `--since 2026-08-06` → `rule5_triggers: 8, rule5_acted: 2`. TRADE-LOG market-open 2026-09-03 and 2026-09-04 (both: "armed and structurally unactionable — `restore_dollars` $356.26 sits below the $510.93 minimum clip"); the Sep 2 XLE fill, the one action, closed $1,619.75 of a $1,952.26 gap and explicitly did not restore the band.
- **Conviction: HIGH — this is now the single highest-value mechanical change available.** Narrowly scoped, and it is the only proposal that would have changed this week's scorecard.

- **`memory/PROJECT-CONTEXT.md` (proposed change): set `trial_start: 2026-08-10`.** Replace the literal `UNSET` on line 43 with the first trading day on which all five routine prompts were running v3.4 text. **Carried unchanged for a fourth week.**
- **Rationale:** While the line reads `UNSET` the go-live scorecard falls back to `min(date)` over `METRICS.jsonl` and permanently includes the 2026-08-06/07 seed pair, which predates both v3.4 fixes and fails `rule14_accuracy` and `rule16_meltup` by construction. **Note the honest change in this item's standing:** for five reviews it was described as "the single blocking item." **It no longer is.** Setting it would clear two of the three trial failures; the third (`deployment`) is now a live defect this week reproduced on current code, so a correct `trial_start` would leave the verdict at FAIL — **which is the right answer and is the point of fixing the line.**
- **Evidence:** This week's two scorecards: the trial window fails `rule14_accuracy` on `['2026-08-07']` and `rule16_meltup` on 2 shallow rotations both dated Aug 7 — artefacts — **and `deployment` on both an Aug 11 run and a fresh Aug 31 – Sep 4 run.** `PROJECT-CONTEXT.md` lines 41–52 predicted the artefact behaviour in writing before the data existed.
- **Conviction: HIGH on correctness, DOWNGRADED on urgency.** One-line human edit, zero trading-behaviour change; it makes the verdict *meaningful* rather than making it PASS.

- **Rule 8 profit ladder / hwm-driven tighten (NEW — cap the tighten on fast satellites, or gate it on the current-price gain): do not tighten a trail off a high-water-mark rung the position's *current* price is more than ~2pp below.** Concretely: fire the tighten branch only when `unrealized_pct` itself has reached the rung, or clamp the tightening step so the new stop sits no closer than ~1.5× the name's recent daily range.
- **Rationale:** CRWD entered Aug 28 at $218.09, closed Monday +5.14%, and Rule 8 tightened 10% → 7% on a **hwm** read of +7.23% while the current-price gain was only **+4.15%** — a rung the position was already 3pp below. Tuesday's -4.99% session, entirely ordinary for the name, took it out at **-0.70%** two sessions after entry. A 10% trail holds it comfortably; the position is still above the entry today. **This is the first time in the phase the ladder has cost money rather than banked it, and the mechanism is specific to high-beta satellites where hwm and current price diverge fast.**
- **Evidence:** TRADE-LOG 2026-08-31 STOP UPDATE (CRWD 10% → 7%, the `--hwm-pct 7.23` vs `$UPCT 4.15` divergence written out in full, with `scaleouts_due` correctly 0 on the current-price read — the ladder's own two legs disagreed and the tighten branch took the aggressive one); 2026-09-01 TRADE CRWD sell (stop `fa045051` fired at $216.57, realized -$9.12). Contrast the ETF cases where the same mechanism worked: XLB Aug 26 (+$47.32 banked), XLV Aug 19.
- **Conviction: MEDIUM-HIGH on the diagnosis, MEDIUM on the fix.** One occurrence, so this is not yet a pattern — but the arithmetic is unambiguous and the asymmetry (ETFs fine, fast single stocks not) is exactly what a `--tier`-aware rule should express. **Explicitly flagged as a single-instance finding rather than a trend, and worth re-checking before applying.**

- **Buy-Side Gate / R:R floor (tier-aware R:R floor for the ETF core): apply the 2:1 R:R floor against a *tier-appropriate* stop width rather than the 10% default.** Size a `tier: core` ETF candidate's R:R using its structural stop (ATR- or level-based, typically 5–7% on a sector ETF) instead of the 10% trail default, **or** lower the core R:R floor to 1.5:1 while leaving the satellite floor at 2:1. Either variant, not both. **Carried from W18, and this week supplies the cleanest evidence yet.**
- **Rationale:** A sector ETF's realistic 4–8-week target is single-digit percent; against a 10% denominator, clearing 2:1 needs a ≥20% projected move. **Friday is the controlled experiment the W18 review asked for:** every other gate was open — clear calendar for the first time in four sessions, $1,378 headroom, core floor clear, weekly cap unbound, a slot free — and the book still closed, because the best of four screen-surviving names (**XLF, at a fresh 200-session closing high**) returned **1.11:1 against the *already relaxed* 1.5:1 floor.** The R:R gate was the sole binding constraint, named as such by the routine.
- **Evidence:** TRADE-LOG market-open 2026-09-04 ("the R:R gate is the sole binding constraint today"); 2026-09-03 pre-market (HOLD, XLE the one screen-passing core name but `floor_skip` under Rule 3); this week's attribution showing the core sleeve at **-1.30% per capital** against satellites at +3.00% — the sleeve that cannot be refreshed is the sleeve that is losing, for a third consecutive week.
- **Conviction: MEDIUM-HIGH on the diagnosis, MEDIUM on the fix.** **Interaction note, restated:** this is *upstream* of the Rule 3 proposal but no longer a substitute for it — Friday's XLF miss was against the relaxed 1.5:1 floor, so relaxing the floor alone would not have admitted it either.

- **Target-methodology (NEW, from 2026-09-04 pre-market — handed up rather than originated here): treat a close within 1% of the 200-session closing high as "at the high" for measured-move target construction.** Currently a name that closes *at* a new high gets a full measured move projected from the breakout, while a name 0.56% *under* its high gets a target computed from the unbroken level — a discontinuity, not a gradient.
- **Rationale:** On Sep 4, **PSX** — RS50 **+46pp**, the strongest satellite on the board — was rejected at **0.05:1** solely because it closed 0.56% below its own 200-session high, while **XLF** at a *new* high received a measured-move target roughly **20× larger**. Two names of comparable structural strength received R:R ratios differing by more than an order of magnitude on a 0.56% price difference. That is a methodology artefact, not a judgement.
- **Evidence:** RESEARCH-LOG 2026-09-04 pre-market (PSX 0.05:1 vs XLF 1.11:1, both refused, the discontinuity documented in the routine's own words); TRADE-LOG 2026-09-04 EOD ("it is the second of two items this routine hands to the weekly review").
- **Conviction: MEDIUM.** The discontinuity is real and one instance is enough to demonstrate it; the 1% tolerance is a starting point, not a measured optimum. **Note the interaction: this and the R:R-floor proposal both attack the same shutout from different sides, and applying both at once would make it impossible to tell which one worked.** Prefer sequencing them.

- **Rule 16 branch 1 (proposed change): give the ETF sector-quadrant exit an operational definition, or remove it. CONVICTION SHIFTED TOWARD REMOVAL.** Suggested test unchanged: rotate a core ETF when its **RS50 vs SPY is negative for 3 consecutive sessions AND its close is below a falling 50-DMA**. **Carried from W16/W17/W18.**
- **Rationale:** Twenty-seven consecutive middays evaluated, zero exercised, every one a written judgement call. **But the case for the "delete it" variant strengthened materially this week:** the *numeric* decay chain produced the phase's first real ETF rotation unaided (XLRE, Aug 31), and on Sep 4 midday correctly declined to raise a flag on XLE that pre-market had forecast — both times on arithmetic, neither time needing branch 1. The branch remains the only path that can override the melt-up guard, which is precisely why an undefined one is a liability.
- **Evidence:** TRADE-LOG 2026-08-31 (XLRE rotation via the decay chain, branch 3); 2026-09-02 through 2026-09-04 middays (branch 1 evaluated and not entered on each, with XLB's RS50 deterioration -0.22pp → -2.59pp explicitly recorded as "an `rscreen` fact, **not** a quadrant exit" — a distinction currently held only by prose).
- **Conviction: HIGH on the need, and now leaning toward removal over definition.**

- **`replace-stop` hwm handling (proposed change): carry the existing high-water mark forward through a trail-percentage change instead of resetting it to the current price.** If the broker cannot preserve hwm on replacement, record the pre-replacement hwm in the STOP UPDATE row and have Rule 8 read hwm-gain from the logged peak rather than the live order field. **Carried from W16/W17/W18.**
- **Rationale:** Unchanged. **No new occurrence this week** — no `replace-stop` was issued after Aug 31, so the defect had no opportunity to recur. It stays on the list at its existing conviction rather than being escalated on silence. **Note it is adjacent to but distinct from the new Rule 8 proposal above:** that one is about *which rung* triggers a tighten, this one about *what the trail is measured against* once it does.
- **Evidence:** TRADE-LOG 2026-08-26 STOP UPDATE (XLB, 5% → 4.1%, arithmetic in full); 2026-08-19 (XLV); 2026-08-11 (XLB).
- **Conviction: HIGH, unchanged.**

- **Operational (proposed change): set `TRADING_MODE=paper` explicitly in the routine UI.** **Thirty-eight consecutive sessions on the unset default** — the longest-standing unactioned item in the log. The default is correct and every routine's mode guard verified it against the endpoint on every session, but the guard exists to catch a half-done live switch and cannot compare a mode that was never set against an endpoint that was. **Free, changes nothing, prerequisite before any live switch. Carried for a sixth week.**

- **Core-sleeve attribution (informational — no rule change proposed yet; the counter advances):** per-capital attribution now shows the **ETF core underperforming the satellite sleeve for three consecutive weeks** — W17 (core +0.28% / sat +1.4%), W18 (core -1.19% / sat -0.55%), **W19 (core -1.30% / sat +3.00%, the widest gap of the phase)**. Last week's note set the bar at "a further two weeks"; **this is the first of those two.** The v3 satellite-sleeve check exists to catch the *opposite* failure and correctly proposes nothing. **If W20 also runs this way, the ≥45% core floor is the rule to re-examine and this note is the anchor for that comparison.** Recorded now with the threshold stated in advance so the decision cannot be rationalised after the fact.

- **Rule 16 melt-up guard (W15 proposal) — SHIPPED and VINDICATED, retired; still clean.** `shallow_rotations` = 0 for a fourth consecutive week. Inspected on the week's only rotation (XLRE, Aug 31) and correctly **disengaged**: SPY 10-session return -0.91%, nowhere near the +3.0% ceiling, so the exit was a genuine relative-weakness read and not a suppressed one. `suppressed` remains 0 for the phase since Aug 12; no new `DECAY-SUPPRESSED` row exists. No action.

- **Rule 14 round-trip convention (W15 proposal) — SHIPPED, retired; still clean.** `rule14_accuracy` true on every session from Aug 10 onward, and the independent local derivation this review ran over Aug 31 – Sep 4 (per-date `activities`) agrees with every logged token at **0**, including the Sep 1 CRWD-sell / MPC-buy session that a naive same-day-fills test would have miscounted. The only inaccurate row in the metrics file remains 2026-08-07. No action.
...
| Metric | Value |
|--------|-------|
| Starting portfolio | $10,254.03 (Sep 4 EOD) |
| Ending portfolio | $10,155.00 (Sep 11 EOD; live `account.equity` at review time $10,156.13 — **+$1.13** post-close mark drift, the usual cosmetic re-mark and the smallest in three weeks; snapshot basis authoritative per STEP 1) |
| Week return | **-$99.03 (-0.966%)** |
| S&P 500 week | **-0.766%** (SPY $770.19 Sep 4 → $764.29 Sep 11, Alpaca bars) |
| Bot vs S&P | **-0.20pp** (endpoint arithmetic: -0.9658% − -0.7660% = -0.1997pp) |
| Alpha vs SPX (v3) | **-0.21pp (headline)** — `metrics.py rollup --since 2026-09-07` returns `cum_alpha_pp -0.2143`, the source of record; the 0.015pp gap to the endpoint figure is daily-sum vs endpoint compounding, not a data disagreement. Series: W13 +0.85 / W14 -3.21 / W15 -2.00 / W16 -0.27 / W17 +1.68 / W18 -1.27 / W19 +0.01 → **W20 -0.21**. **Decomposition (rollup): cash drag +0.32pp / selection -0.53pp.** Both legs are the mirror of the phase's usual shape: on a week SPY lost 0.77%, the 41% cash pile was worth *a third of a point of protection*, and the entire miss came from what was owned. This is the first week of the phase in which the under-deployment is unambiguously **not** the cause of the shortfall — see Key Lessons |
| Core/Satellite P&L (v3) | **core -$32.93 / satellite -$65.97** (per capital: core **-0.77%** on ~$4,268 session-weighted, satellite **-2.74%** on ~$2,406). Attribution reconciles to **14 cents** against the -$99.03 equity move ($0.09 of CAT/REG/TAF fees plus rounding) |
| Trades | **2 buys** (XLF 18sh Sep 9, XLF 17sh Sep 10 — one name, 2/5 weekly cap used) · **3 closures** (W:1 / L:2) · **open:4** |
| Win rate | **33.3%** (1 of 3 closed) |
| Best trade | **XLB +3.02%** (+$40.77) |
| Worst trade | **XLV -4.37%** (-$53.32) |
| Profit factor | **0.66** ($40.77 gains / $62.23 losses; net realized **-$21.46**) |
| daytrade_count | **0 (source=local, derived — field absent from the paper `/account` payload) [conservative: 3]**; delta vs prior week **0 -> 0 (source=local) [conservative: 3]**, no change. 101 trading days / **20 consecutive weeks at zero day trades** |

**Benchmark provenance:** `prior_close` $770.19 (Sep 4) is read from last week's entry as recorded, not re-queried — Alpaca's `adjustment=all` mutates historical closes retroactively, and the cached read is what keeps the alpha series comparable. It agrees to the cent with this week's bars pull. `last_close` $764.29 (Sep 11) from this week's `bars SPY 1Day 10`. **No prior week's benchmark figure has been revised.** *(Minor, noted not corrected: the Sep 10 METRICS row recorded SPY at $757.89 against the settled bar $757.83 — 6c, taken at snapshot time before the final print. The week is computed endpoint-to-endpoint from settled bars, so it affects no figure here. Same class of drift as the Aug 31 3c note.)*

**Metrics completeness:** all 5 session-days present in `memory/METRICS.jsonl` (Sep 7, 8, 9, 10, 11). Nothing is marked `incomplete`; no figure in this entry was hand-assembled.

### Closed Trades
| Ticker | Entry | Exit | P&L | Notes |
|--------|-------|------|-----|-------|
| XLV (4sh) | $169.7473 blended | $167.52 (Sep 8, two prints) | **-$8.91 (-1.31%)** | Trailing-stop fill in the opening auction on the 5% leg tightened Aug 20 by the Rule 8 ladder. On the *original* Jul 31 lot basis ($161.92) the same shares book **+$22.40 / +3.46%** — the blended figure is the one carried to the phase tally, since Alpaca allocates against the position average. The tight 5% trail converted a -2.24% session into an exit at $167.52 rather than a ride to the 10% leg's $158.238 |
| XLB (27sh) | $50.08 (May 18) | $51.59 (Sep 9) | **+$40.77 (+3.02%)** | Trailing-stop fill at 09:21 CT on the 4.1% trail forced by the Aug 26 Rule 8 tightening. **The log flagged this exact outcome on nine consecutive sessions** — sub-1% of room, Rule 9 forbidding any loosening, and the ladder's +7 rung returning a *looser* 5% target that Rule 9 also blocked. A sub-1% Materials down-move closed the book's third-largest position and booked away a +4.73% unrealized gain. No routine had a tick at which it could intervene; the position was gone before midday |
| XLV (7sh) | $174.22 (reset basis) | $166.6029 (Sep 9) | **-$53.32 (-4.37%)** | **Rule 16 momentum-decay rotation — the cleanest textbook execution of the rule to date.** Second consecutive midday flag (Sep 8 → Sep 9), below entry (-4.37%) AND lagging SPY by 4.55pp over 10 sessions (-4.95% vs -0.40%). The melt-up guard was structurally disengaged on **both** legs (drawdown 2.37pp deeper than the -2.0% floor, benchmark 3.40pp under the +3.0% ceiling), so branch 2 could not withhold the sell. Stop `60dcfc62` cancelled to free `qty_available`, then closed; **no orphan order** |

### Open Positions at Week End
| Ticker | Shares | Entry | Close | Unrealized | Stop |
|--------|--------|-------|-------|-----------|------|
| XLF | 35 | $56.8523 | $57.23 | +$13.22 (+0.66%) | $51.8535 on 18sh (10% trail, GTC `3d2c2773`, hwm $57.615) + $51.8535 on 17sh (10% trail, GTC `a45cebbd`, hwm $57.615) |
| XLE | 25 | $64.79 | $65.16 | +$9.25 (+0.57%) | $59.553 (10% trail, GTC `be71317b`, hwm $66.17) |
| GILD | 11 | $144.3136 | $143.72 | -$6.53 (-0.41%) | $137.286 (10% trail, GTC `e9c7b266`, hwm $152.54) |
| MPC | 2 | $377.96 | $395.93 | +$35.94 (+4.75%) | $380.4723 (7% trail, GTC `f5838f8f`, hwm $409.11) |

daytrade_count: **0 (source=local — derived, field absent from the paper `/account` payload) [conservative: 3]**. Positions **4/6**, two slots free. **ETF core $3,632.05 = 60.49% of deployed** ≥45% floor ✓. **Satellite sleeve 2/3** (GILD, MPC), **≤2 per sector ✓** (Health Care 1, Energy 1). **Deployment 59.13% — a twelfth consecutive session below the 75% floor and the whole week outside the band** (see Rule violations). Sector spread of deployed: Energy **40.32%** (XLE 27.13% + MPC 13.19%), Financials **33.36%**, Health Care **26.33%** — all ≤50% Rule 12 cap ✓. Position weights vs equity: XLF **19.72%** (largest, **0.28pp of margin** to the Rule 3 cap — the thinnest of the phase), XLE 16.04%, GILD 15.57%, MPC 7.80%. **All 4 names carry armed GTC trailing stops across 5 orders covering 73 / 73 held shares** — zero unprotected names, **thirty-third consecutive EOD at zero**, zero orphan orders, Rule 17 scan returns zero open `STOP-PLACEMENT-FAILED` rows. Cash **$4,150.17 (40.87%)**; headroom to the 85% ceiling **$2,626.42** = 5.1 minimum clips.

### Rule violations (audit)
- **Rule 5 (75–85% deployment band) — breached on 5 of 5 sessions**: 71.61 / 64.84 / 49.72 / 59.08 / 59.13. Sep 9's **49.72%** is the lowest reading of the phase. This is the twelfth consecutive session below the floor and the sixth consecutive *week* in which the band has bound. **Rule 5 armed on all 5 sessions and acted on 2** (`rule5_triggers: 5, rule5_acted: 2` — the Sep 9 and Sep 10 XLF adds).
- **Rule 3 / Rule 6 / Rule 7 / Rule 9 / Rule 12 / Rule 13 / Rule 14 / Rule 16 / core floor / satellite caps / weekly cap: clean.** Zero money-moving breaches — no day trade, no stop moved down or loosened, no position at or beyond -7%, no sell placed with DTC ≥ 2, no option touched.
- **Rule 14 audit-token sweep: 10 found / 10 expected, zero gaps.** 5 session-days × 2 routines. Session by session: Sep 7 market-open ✓ midday ✓ · Sep 8 ✓ ✓ · Sep 9 ✓ ✓ · Sep 10 ✓ ✓ · Sep 11 ✓ ✓. (Sep 7 was Labor Day with markets closed; both routines still ran and still logged the token, which is the correct behaviour — the token must appear on **every** path.) No manual `/trade` entries this week, so no extra tokens expected.

### Go-live scorecard (v3.4)

```
Go-live scorecard — TRIAL WINDOW 2026-08-06..2026-09-11 (27 sessions). Verdict: FAIL.
Weekly scorecard (2026-09-07..2026-09-11, informational only): FAIL.
```

**`TRIAL_START` resolution — read this before the table.** `memory/PROJECT-CONTEXT.md` carries `trial_start: UNSET`, which is a placeholder, not a date. It cannot be passed to `--since`, so the window fell through to the documented fallback: the minimum `date` in `memory/METRICS.jsonl` = **2026-08-06**. PROJECT-CONTEXT predicts the consequence in terms, and the prediction is exactly borne out — the window drags in the deliberately defective 2026-08-06/07 seed pair, which predates both the Rule 16 melt-up guard and the Rule 14 round-trip fix. **This is the sixth consecutive weekly review at which `trial_start` has reached the scorecard unset.**

| Criterion | Verdict | Detail |
|---|---|---|
| `cadence` | **PASS** | 108/108 routine slots across 27 sessions, zero missing |
| `rule14_tokens` | **PASS** | 54/54 Rule 14 audit tokens |
| `rule14_accuracy` | **FAIL** | inaccurate on **`['2026-08-07']`** — the seed row, which records `dtc: 2`. Sole failing date; every one of the other 26 sessions is accurate |
| `unprotected` | **PASS** | zero held positions without a GTC trailing stop at any EOD, all 27 sessions |
| `breaches` | **PASS** | zero money-moving rule breaches |
| `rule16_meltup` | **FAIL** | **2 shallow melt-up rotations**, both on **2026-08-07** — the same seed row. Zero across the other 26 sessions |
| `deployment` | **FAIL** | `2026-08-11: 3 consecutive sessions below the 75.0% floor`. Not attributable to the seed pair — see below |

`alpha_informational` **(NOT a gate)**: `cum_alpha_pp -0.6121`, `cum_cash_drag_pp +0.3519`, `cum_selection_alpha_pp -0.9640` over the 27-session window.

**The verdict does not change if the seed pair is excluded, and that is the finding that matters.** Diagnostic run, `--since 2026-08-10` (25 sessions, seed pair dropped): `rule14_accuracy` **PASS**, `rule16_meltup` **PASS** — and `deployment` still **FAIL** (`2026-08-12: 3 consecutive sessions below the 75.0% floor`), so the headline verdict is still **FAIL**. Two conclusions follow, and they are separate:
1. **Setting `trial_start` correctly would clear two of the three failing criteria immediately.** They are artefacts of the window, not of current behaviour; the guard and the round-trip fix have held for 25 consecutive sessions.
2. **`deployment` is a genuine failure and would fail under any honest window.** It is not an artefact, it is not rescued by a boundary choice, and it is the one criterion standing between this trial and a go verdict.

**`deployment` FAIL diagnostics (v3.4):** `rule5_triggers: 13, rule5_acted: 4` over the trial window. This is the **`triggers > 0, acted > 0` but badly under-spent** shape — not the pure melt-up RS hole of `docs/LIVE-SMOKE-TEST.md` §8 (`triggers > 0, acted == 0`), and not a broken trigger (`triggers == 0`). Rule 5 armed on 13 sessions and produced an add on 4 of them, a **31% conversion**, and `sessions_in_band: 9` of 27 means the book was inside its own mandated band on **one session in three**. Neither reading changes the verdict; both say the same thing about what to fix — the trigger fires, the relaxed 1.5:1 floor is reachable (XLF cleared it twice this week at 1.61:1 and 1.55:1), but the pre-market is not surfacing enough admissible ideas to spend the budget, and on the 9 sessions it surfaced none the relaxation was inert. The Sep 11 session states it plainly: eighth consecutive armed session with $0 of the relaxed budget used.

**Weekly scorecard (informational).** `2026-09-07..2026-09-11`, 5 sessions: `cadence` PASS (20/20), `rule14_tokens` PASS (10/10), `rule14_accuracy` PASS, `unprotected` PASS, `breaches` PASS, `rule16_meltup` PASS, **`deployment` FAIL** (`2026-09-09: 3 consecutive sessions below the 75.0% floor`). Weekly and trial-window verdicts **agree** this week — both FAIL, and both on `deployment`. There is no straddling-run divergence to explain.

### What Worked
- **Rule 16 executed its textbook case and the guard stayed out of the way.** XLV's Sep 9 rotation is the cleanest decay-chain exit of the phase: two consecutive flags, below entry, lagging SPY by 4.55pp over ten sessions, and the melt-up guard structurally disengaged on **both** legs rather than by luck on one. The stop was cancelled to free `qty_available` and no orphan order was left behind. -$53.32 booked, and XLV fell further into the week's close.
- **The cash pile paid for itself, for once.** +0.32pp of cash drag — *positive* — on a week SPY lost 0.77%. Sep 9 (+0.41pp alpha) and Sep 10 (+0.23pp) were both carried primarily by not being invested. The same 41% cash that costs a third of a point on an up day earned roughly that back on the down days.
- **Rule 5 acted twice in one week for the first time in the phase.** Two XLF adds on consecutive sessions (18sh at 1.61:1, 17sh at 1.55:1), both admitted at the relaxed core floor, both honest in the log about the thin credential — Wednesday's entry warned RS50 was "one screen from exclusion"; Thursday's entry **corrected its own prior framing** rather than quietly dropping it when the next bar read +3.33pp instead of continuing down. That self-correction in the research record is worth more than the trade.
- **Process held: 20/20 cadence, 10/10 audit tokens with zero session gaps, 33 consecutive sessions at zero unprotected positions, zero money-moving breaches, attribution reconciled to 14 cents.** Five sessions, three exits, two entries, and not one of them touched a rule edge.

### What Didn't Work
- **Selection, and only selection.** -0.53pp. The week's entire shortfall is in what was owned. **GILD alone is -$80.03 of a -$99.03 week** — 81% of the loss from one 15.6% position that fell 4.8% while SPY fell 0.77%, including a 0.75% decline into Friday's 0.85% up-tape.
- **XLB's exit was a nine-session-telegraphed loss of control, not a decision.** The 4.1% trail forced by the Aug 26 ladder step could never be loosened (Rule 9), the ladder's own +7 rung returned a *looser* 5% target that Rule 9 also blocked, and the position sat locked into a stop the rulebook would never newly place. It exited on a sub-1% Materials down-move at 09:21 CT — before any routine had a tick. **The log flagged this on nine consecutive sessions and no mechanism existed to act on the flag.** +3.02% booked against a +4.73% unrealized gain the week before.
- **Deployment reached the lowest point of the phase.** 49.72% on Sep 9 — a book with more than half its equity idle. Twelve consecutive sessions below the floor, sixth consecutive week.
- **Two XLF adds on consecutive days put 19.72% into one name.** Inside the Rule 3 cap, but with **0.28pp of margin** — the thinnest weight of the phase. Rule 5's restore budget pushed the book into single-name concentration because XLF was the only idea clearing even the relaxed floor, which is the deployment problem re-expressed as a concentration problem.

### Key Lessons
- **The under-deployment thesis has to be stated more carefully after this week.** Five prior weeks read "the book lags because it is not invested." This week the cash *helped* (+0.32pp) and the book still lost to the index, because selection cost -0.53pp. Both things are true and they are not the same problem: **cash drag is a timing cost that shows up on up-weeks; selection is a cost that shows up regardless.** The Rule 5 fix addresses the first and does nothing for the second. Recorded now so that next week's review does not attribute a selection miss to deployment out of habit.
- **The core-sleeve counter reset, and it reset against the pre-stated threshold.** Last week's entry set the bar in advance: "If W20 also runs this way, the ≥45% core floor is the rule to re-examine." **W20 did not run that way** — core -0.77% per capital *outperformed* satellite -2.74%, the first such week since W16. The three-week run (W17/W18/W19) is broken at three. **No proposal is owed and none is made.** The threshold was set before the data arrived and it is being honoured in the direction that produces *less* change, which is the only way a pre-commitment is worth anything.
- **A stop that Rule 9 has locked below the rulebook's own minimum is an unmanaged risk, not a protected position.** XLB spent nine sessions with under 3% of room — beneath Rule 9's own "never within 3% of current price" floor — and Rule 9 blocked every available remedy because each one was technically a loosening. The rule that exists to prevent stops being widened produced a position no routine could manage. This is the second rule-interaction defect the phase has surfaced (after Rule 5's arm-without-spend) and it has the same shape: a safety rule with no branch for the case where its own constraint is the hazard.
- **`trial_start: UNSET` is now a six-week-old known defect that materially misstates the scorecard.** It costs two false FAILs per week and has done so since the trial began. It is a one-line edit to a file this routine is forbidden to make silently — so it goes to proposed changes again, with the diagnostic showing exactly what it would and would not fix.

### Adjustments for Next Week
- **GILD is the live thread into Monday.** It opened a decay chain Friday midday (`flag=1`, `rotate=0`, `reason=first_flag`), closed -0.41% below entry and lagging SPY by 2.72pp over ten sessions, then *widened* the gap into the bell. If it is still below entry and still lagging at Monday's midday, `prior_flag=1` makes it a **Rule 16 rotation** — the position is aged (entered Aug 21), so Rule 15 will not shield it and the sell will execute. Melt-up guard check for Monday: the rotation is only withheld if GILD is shallower than -2.0% *and* SPY's 10-session return exceeds +3.0%; neither is currently close. No action is pre-authorised here — midday recomputes and decides.
- **Pre-market: the binding constraint is idea supply, not the R:R floor.** Rule 5 armed on all 5 sessions and spent budget on 2. The two that converted were the same name on consecutive days. Widen the screened universe before touching any floor.
- **Watch XLF's weight, not just its thesis.** 19.72% with 0.28pp of Rule 3 margin means no further add is possible, and a 1.5% XLF rally alone would breach the cap on mark-to-market. The Rule 3 ceiling is a hard maximum and this is the closest the book has come to it.
- **Energy is 40.32% of deployed across XLE + MPC.** Inside Rule 12's 50% cap, but any Energy add is now near-unavailable, and MPC at +4.75% on a 7% trail is the book's most profitable and most tightly-stopped name.

### Satellite-sleeve check (v3)
**No proposal owed, and the run has ended.** The check fires only when the satellite sleeve has underperformed the ETF core per-capital for **3+ consecutive weeks**. Attribution across the last four entries: **W17** core +$17.36 / sat +$17.01 (satellite over) · **W18** core -$73.26 / sat -$8.64 (satellite over) · **W19** core -$61.13 / sat +$73.93 (satellite over) · **W20** core **-0.77%** per capital / satellite **-2.74%** per capital (**core over** — the first such week since W16). The condition this check exists to catch has never been met, and this week the counter is at **1**, not 3. The *opposite* counter — the core-sleeve note tracked informationally since W18 — reached 3 last week with a pre-stated "one more week" threshold and **has now reset at three**. Both counters are recorded honestly rather than re-based to preserve a narrative.

### Overall Grade: B-

**A losing week in which almost every mechanism did its job and the loss came from somewhere the mechanisms do not reach.** -0.966% against SPY's -0.766% is **-0.21pp**, the second-worst of the last four weeks but by a narrow margin, and the composition is the most informative thing in this entry: **cash drag +0.32pp, selection -0.53pp**. For five weeks the story has been "under-deployed"; this week the cash was an asset and the book still lost, with **GILD alone accounting for 81% of the dollar loss**. Process was exemplary for a seventh straight week — 20/20 cadence, 10/10 audit tokens with zero session gaps, 33 consecutive sessions at zero unprotected positions, zero money-moving breaches, attribution reconciled to fourteen cents, and Rule 16's cleanest rotation of the phase. Two things keep it off a B. **Deployment failed the go-live scorecard on its own merits** — the diagnostic run excluding the defective seed pair clears both other failing criteria and `deployment` still fails, so this is not a windowing artefact and the trial is genuinely no-go. And **XLB exited on a nine-session-telegraphed stop lock-up that no routine could intervene in** — a +4.73% unrealized gain booked at +3.02% by a rule interaction the log saw coming every day for two weeks and had no branch to handle. Neither is a breach; both are the kind of structural defect a paper trial exists to find, which is the one argument for not grading lower.

## Proposed strategy changes (NOT auto-applied — human review required)

- **PROJECT-CONTEXT `trial_start` (proposed change):** set `trial_start: 2026-08-10` in `memory/PROJECT-CONTEXT.md`, replacing the `UNSET` placeholder. 2026-08-10 is the first session after the 2026-08-06/07 seed pair — i.e. the first trading day on which the Rule 16 melt-up guard and the Rule 14 round-trip fix were both live.
- **Rationale:** the placeholder has reached the go-live scorecard unset for six consecutive weekly reviews and costs two false FAILs every week (`rule14_accuracy` and `rule16_meltup`, both attributable in full to the single 2026-08-07 row).
- **Evidence:** trial-window scorecard `--since 2026-08-06` returns FAIL on `rule14_accuracy` (`inaccurate on ['2026-08-07']`) and `rule16_meltup` (2 shallow rotations, both dated 2026-08-07); the diagnostic `--since 2026-08-10` returns PASS on both across 25 sessions. **Stated plainly so this is not read as gaming the window: the correction does NOT change the verdict.** `deployment` fails under both windows and the headline stays FAIL. The proposal is worth making because it makes the scorecard report current behaviour truthfully, not because it improves the outcome.

- **Rule 9 (proposed change):** add a bounded exception — when a position's trailing stop sits **within 3% of the current price** (Rule 9's own stated minimum distance) **and** the Rule 8 ladder's target trail for the position's current rung is *looser* than the standing trail, permit a one-time widening to the ladder's target trail, capped at the ladder value and logged as a `STOP RELAXED` row with the triggering rung. Never permit widening for any other reason.
...
- **Evidence:** TRADE-LOG `2026-09-09 — TRADE: XLB side=sell qty=27` (stop-fill at $51.59 on a 4.1% trail, exiting 14.5% below target and booking +3.02% against the prior week's +4.73% unrealized); the Sep 4 EOD snapshot recording "$51.5942 against a $52.45 close — 1.63% of room... barely half of Rule 9's own 3% no-stop-within-3%-of-price floor" and noting the ladder's +7 rung returned a *looser* 5% target that Rule 9 blocked; the same condition flagged on **nine consecutive sessions** from Aug 28 through Sep 8 with no available action.

- **Rule 5 / pre-market screen (proposed change):** when the re-deployment trigger has been armed for **3+ consecutive sessions with `rule5.acted: false` on each**, widen the pre-market's screened universe for `tier: core` candidates only — add the remaining S&P sector SPDRs and the broad-market ETFs (SPY, RSP, IWM) to the core screen for that session — rather than relaxing the R:R floor any further.
- **Rationale:** the trial-window diagnostics read `rule5_triggers: 13, rule5_acted: 4`; the relaxed 1.5:1 floor is demonstrably reachable (XLF cleared it twice this week at 1.61:1 and 1.55:1), so the binding constraint is idea *supply*, not the threshold — and relaxing the threshold further trades deployment for selection quality, which this week's -0.53pp says the book cannot afford.
- **Evidence:** TRADE-LOG `Sep 11 — EOD Snapshot` ("Rule 5 REDEPLOY was armed... and again went entirely unspent — an eighth consecutive armed session with $0 of the relaxed budget used... the constraint is not the 2:1 floor, it is that the pre-market is not surfacing ideas that clear even 1.5:1"); `metrics.py rollup --since 2026-08-06` → `rule5_triggers: 13, rule5_acted: 4, sessions_in_band: 9` of 27; this week's 5/5 sessions below floor with the phase-low 49.72% on Sep 9.
...
*(Week 22 · Day 111 · paper — `TRADING_MODE` unset → defaults to `paper`; `ALPACA_ENDPOINT` = `https://paper-api.alpaca.markets/v2` contains `paper-api.alpaca.markets` ✓, mode and endpoint agree, neither inferred from the other; `TRADING_ENABLED=true` ✓; MODE_LABEL `(paper)`, no `🔴 LIVE` prefix. No `.env` created or sourced.)*

### Stats
| Metric | Value |
|--------|-------|
| Starting portfolio | $10,220.35 (Sep 18 EOD) |
| Ending portfolio | $10,167.74 (Sep 25 EOD; live `account.equity` at review time $10,167.74 — snapshot and live agree to the cent) |
| Week return | **−$52.61 (−0.515%)** |
| S&P 500 week | **+1.268%** (SPY $761.69 Sep 18 → $771.35 Sep 25, Alpaca bars) |
| Bot vs S&P | **−1.78pp** (endpoint arithmetic: −0.5148% − +1.2682% = −1.7830pp) |
| Alpha vs SPX (v3) | **−1.78pp (headline, endpoint)** — **the rollup is NOT the source of record this week and this is the reason.** `metrics.py rollup --since 2026-09-21` returns `cum_alpha_pp −2.4721`, but over **4 sessions, not 5**: `METRICS.jsonl` has no `2026-09-23` row because that day's `daily-summary` never ran. The missing session is the one on which SPY fell (−0.72%) while the book was 84% cash, i.e. the week's single best alpha day, so the rollup understates by ~0.69pp. Per STEP 3 the affected figures are marked **`incomplete`** rather than hand-filled; the endpoint arithmetic is complete on both legs and is used as the headline. Series: W13 +0.85 / W14 −3.21 / W15 −2.00 / W16 −0.27 / W17 +1.68 / W18 −1.27 / W19 +0.01 / W20 −0.21 / W21 +0.72 → **W22 −1.78** — the worst alpha week since W15. **Decomposition (rollup, `incomplete` — 4 of 5 sessions): cash drag −1.44pp / selection −1.03pp.** Unlike W21, the miss is *not* mostly selection: with SPY up 1.27% on the week, being 84% in cash is most of the story, and for once both halves are negative |
| Core/Satellite P&L (v3) | **core −$47.37 / satellite −$5.24** (GILD +$15.29, MPC −$20.53). Per capital, averaging each sleeve's mark across all **five** week sessions including the ones it was flat: core **−7.47%** on ~$634 · satellite **−0.30%** on ~$1,741. The core figure is inflated by XLE being held only 2 of 5 sessions — on held-session capital (~$1,585) it is **−2.99%**. Attribution reconciles to **$0.00** against the −$52.61 equity move; cash delta +$1,965.97 equals MPC $404.47 + XLE $1,561.50 exactly, no fees |
| Trades | **0 buys** (0/5 weekly cap used) · 2 closures (W:1 / L:1) · open at week end: 1 |
| Win rate | **50.0% (1/2)** |
| Best trade | **MPC +7.01%** (+$26.51) |
| Worst trade | **XLE −3.60%** (−$58.25) |
| Profit factor | **0.46** ($26.51 / $58.25) |
| daytrade_count | **0 (source=local, derived — field absent from the paper `/account` payload) [conservative: 2]**; delta vs prior week **0 -> 0 (source=local) [conservative: 2]**, no change. **111 trading days / 22 consecutive weeks at zero day trades** |

**Benchmark provenance:** `prior_close` $761.69 (Sep 18) read from the W21 entry as recorded, **not re-queried**. `last_close` $771.35 (Sep 25) from this week's `bars SPY 1Day 10`. **No prior week's benchmark figure has been revised.** No web-sourced index level was substituted at any point.

**Rule 14 resolution (one resolution, used for both the pre-flight and the delta):** `alpaca.sh dtc` → `{"daytrade_count": null, "source": "unavailable"}` — a **successful** call with the field absent, which v3.4 routes to the local derivation (an `error` is barred from it). `activities` polled per-day across the five business days 2026-09-19 → 2026-09-25 returns fills on **two** dates only: Sep 21 MPC sell 1sh @ $404.47, Sep 22 XLE sell 25sh @ $62.46. **Zero buys anywhere in the window**, so **zero same-day round trips** → `DTC = 0`. Raw sell-only tally `DTC_CONSERVATIVE = 2`, logged and never gating. TRADE-LOG corroborates identically; `max(broker, log) = 0`.

**Rule 14 audit-token sweep (v3.3):** **10/10 expected tokens present (2 × 5 trading sessions).** Session by session, every one of 2026-09-21, 09-22, 09-23, 09-24, 09-25 carries `Rule 14 DTC:` in **both** its `- market-open <date>:` row and its `- midday <date>:` row. **Zero `Rule 14 audit gap` findings.** — *and a detector finding in its own right:* `metrics.py scorecard --since 2026-09-21` reports `rule14_tokens 8/8 PASS`, not 10/10, because the scorecard counts from `METRICS.jsonl` and Sep 23 has no row there. The Sep 23 tokens **are** present in TRADE-LOG.md; the scorecard simply cannot see that session. A session that goes missing from the metrics file therefore drops silently out of the token criterion's denominator instead of failing it — the same missing-detector shape the sweep exists to catch. See Proposed strategy changes (1).

### Closed Trades
| Ticker | Entry | Exit | P&L | Notes |
| ------ | ----- | ---- | --- | ----- |
| MPC (1sh) | $377.96 (2026-09-01, `Tier: satellite`, Energy) | $404.47 (2026-09-21 14:20 CT, GTC trailing stop `9868db02` @ 6% fired) | **+$26.51 (+7.01%)** | **Clean Rule 6/8 exit — the trail did exactly its job.** The 6% trail had been ratcheted by the Rule 8 ladder from the canonical 10%; hwm $431.08 → stop $405.2152. Fired 2h20m after midday's snapshot, so no routine saw it live; picked up from `activities` by daily-summary. Closes the two-share MPC trade at **+$65.44** total including the Sep 16 scale-out slice. Position was 30 sessions old — no day-trade exposure |
| XLE (25sh) | $64.79 (2026-09-02, `Tier: core`, Energy) | $62.46 (2026-09-22 12:13 CT, market order `d48dd966`) | **−$58.25 (−3.60%)** | **Rule 16 momentum-decay rotation, executed correctly and gated correctly.** Second consecutive midday flag (Sep 21 → Sep 22), below entry (−3.59%) **and** lagging SPY by **421bp** over 10 sessions (−3.01% vs +1.21%). Branch 1 (sector-quadrant) checked **first** and cleared — Energy RS50 +11.37pp, still leading — so this is a `trigger: decay-chain` exit, not `sector-quadrant`. Melt-up guard structurally unavailable on **both** legs (drawdown −3.59% deeper than the −2.0% floor; SPY 10-session +1.21% against the +3.0% threshold), so branch 2 could not withhold the sell — the guard was evaluated, not skipped. Standing 10% GTC trail `be71317b` cancelled at 12:13 to free `qty_available`, then the position closed; no orphan order remains |

### Open Positions at Week End
| Ticker | Entry | Close | Unrealized | Stop |
| ------ | ----- | ----- | ---------- | ---- |
| GILD (11sh) | $144.313636 (2026-08-21, `Tier: satellite`, Health Care/biotech) | $150.93 | **+$72.78 (+4.59%)** | $143.405907 — 7% trail, GTC `c6c4a202`, hwm $154.1999. Room to stop on the live mark **4.98%**, clear of Rule 9's 3% floor |

**daytrade_count: 0** (source=local, derived — field absent) [conservative: 2]. **Zero unprotected positions at every EOD this week — 43rd consecutive session.** Rule 3 max weight GILD **16.33%** ✓ (ceiling 20%). Satellites **1/3** ✓, ≤2 per sector ✓, positions **1/6**. Max sector Health Care **100.0% of deployed** — above the Rule 12 50% cap, but on a single $1,660 position in an 84%-cash book; Rule 12 is forward-looking and forces no sell. **ETF core 0.00% of deployed — the ≥45% floor is violated outright**, see What Didn't Work.

### What Worked
- **Both sells were textbook, and one of them made money.** MPC's ratcheted 6% trail fired unattended at +7.01% and closed the two-share trade at +$65.44 — Rules 6, 8 and 9 composing exactly as designed with no routine in the loop. XLE's rotation walked the Rule 16 branch chain in strict order, checked the sector-quadrant branch *before* `suppressed`, and recorded why the melt-up guard was unavailable rather than silently not firing. Neither sell was a judgement call; both were the rulebook executing.
- **Process held under a cadence failure.** `daily-summary` did not run Wednesday. The v3.3 recovery path caught it the next morning without prompting: `pre-market` 2026-09-24 STEP 0 detected the missing EOD snapshot, cross-checked `METRICS.jsonl` independently, sent the URGENT, wrote the placeholder, **and ran the Rule 13 stop-placement recovery** — which correctly found nothing owed, because GILD already carried a 7% trail that Rule 9 forbids replacing with the canonical 10%. That is the recovery working on the easy case; it is worth saying plainly that the hard case (a session on which positions *are* opened) has still never been exercised.
- **Zero day trades for a 22nd consecutive week**, and the Rule 14 gate genuinely ran on all ten routine slots rather than being assumed. The `source=unavailable` → local-derivation path has now executed for 33 consecutive sessions without once being collapsed into `error`.

### What Didn't Work
- **The core sleeve went to zero and took the entire buy side with it.** XLE's Sep 22 rotation was individually correct and left `CORE_MV = $0.00`. The satellite gate is `CORE_MV / (LMV + S) ≥ 0.45`; at `CORE_MV = 0` that inequality has **no solution for any `S > 0`**, so from Sep 23 onward **no satellite was purchasable at any size, for any R:R, on any catalyst**. Core adds were independently refused by R:R for a sixth straight week (XLK refused at 0.67 → 0.25 → 0.14:1 on three consecutive sessions). The two blocks close a loop: the only thing that can unlock satellites is a core buy, and core buys are the thing that never passes. **The book can currently only shrink.** This is not a rule being violated — it is two rules that are each correct in isolation composing into a state with no legal exit, and no detector noticed, because nothing in the scorecard asks "is any buy reachable at all?"
- **Deployment hit a phase low of 16.33%, a 20th consecutive session below the 75% floor**, and cost −1.44pp of cash drag in a week SPY rose 1.27%. `rule5_triggers: 4, rule5_acted: 0`. The Rule 5 relaxation armed on every session of the week and has now armed 22 times in the trial window against 4 actions. The W20/W21 diagnosis — the binding constraint is idea *supply*, not the R:R threshold — survives another week, and this week it is joined by the core-floor lock above.
- **A routine slot was silently dropped, and its absence is self-concealing.** The Sep 23 `daily-summary` miss cost the week an EOD snapshot and a metrics row. Because the scorecard's `cadence` and `rule14_tokens` criteria both count *from* `METRICS.jsonl`, a session with no row is not counted as missing — it is not counted at all. `cadence` reported **16/16 PASS** for a week in which 1 of 20 routine slots did not run. The criterion that exists to catch a dropped routine cannot see a routine drop that also drops the metrics row, which is precisely the failure mode that occurred.
- **The alpha decomposition turned negative on both halves for the first time since W15.** Cash drag −1.44pp and selection −1.03pp (incomplete, 4 sessions). Last week's +0.88pp of selection alpha came from a concentrated remnant beating a falling tape; this week the same remnant lagged a rising one. Two weeks, opposite signs, same book — which is exactly why alpha is informational and not a gate.

### Key Lessons
- **Two individually-correct gates can compose into a deadlock, and nothing in the current process looks for that.** Rule 16 sold the last core ETF because it was decaying (correct). The ≥45% core floor then blocked every satellite because core was empty (correct). The conjunction is a book that cannot buy anything. Every rule audit this week passes; the portfolio is still stuck. **Per-rule compliance is not a proxy for system liveness**, and the go-live scorecard currently measures only the former.
- **A detector that reads the same file a failure deleted cannot detect that failure.** `cadence` and `rule14_tokens` both PASS for a week with a missing session. The fix is not a better threshold — it is deriving the expected-session list from a trading calendar rather than from the rows that happen to be present.
- **The Rule 16 melt-up guard is not what withheld anything this week** — it was unavailable on both legs and said so. Worth recording because "the guard didn't fire" and "the guard wasn't engaged" are different facts, and only the second one is true here.
- **Zero-buy weeks are not all the same thing.** W21's zero buys were R:R refusing marginal ideas — Rule 12 patience. W22's zero buys were, from Wednesday on, arithmetic: five satellite names passed `rscreen` on Sep 23 and **none was reachable at any size**. Calling both "patience" flatters the second one.

### Adjustments for Next Week
- **The core-floor deadlock is the only thing that matters on Monday.** It is a rulebook interaction, so per DECIDED G it is proposed below and not applied. If it is not resolved by hand before Monday's open, Week 23 will be a third consecutive zero-buy week by construction, regardless of what the tape offers.
- Investigate the 15:00 CT cron. This is the second missed `daily-summary` of the phase and the fourth missed routine overall; so far every miss has landed on a day with nothing owed, which is luck rather than design.
- GILD is the whole book: +4.59%, flag=0 for eight consecutive middays, leading SPY by ~310bp over 10 sessions, 4.98% of room to its 7% trail. No action owed; Rule 8's +6 stock rung remains the next event.
- Carry the MPC `### … TRADE: MPC side=sell` header row into the log by hand — Rule 10's sector-kill scan is header-anchored and currently cannot see a winning Energy exit that did occur.

### Go-live scorecard (v3.4)

```
Go-live scorecard — TRIAL WINDOW 2026-08-06..2026-09-25 (36 sessions). Verdict: FAIL.
Weekly scorecard (2026-09-21..2026-09-25, informational only): FAIL.
```

**`TRIAL_START` resolution.** `memory/PROJECT-CONTEXT.md` line 43 reads `trial_start: UNSET` — a placeholder, not a date, and that file documents its own fallback ("while it reads `UNSET` the scorecard falls back to the earliest record in `memory/METRICS.jsonl`"). So `TRIAL_START = 2026-08-06`, the minimum `date` across all 36 rows. **This is the eighth consecutive weekly review run on the placeholder**, and it costs two FAILs that are attributable in full to the deliberately-defective 2026-08-06/07 seed pair. See Proposed strategy changes (3).

| Criterion | Verdict | Detail |
|---|---|---|
| `cadence` | **PASS** | 144/144 routine slots — **but see the caveat below; this PASS is not trustworthy this week** |
| `rule14_tokens` | **PASS** | 72/72 Rule 14 audit tokens — same caveat |
| `rule14_accuracy` | **FAIL** | `inaccurate on ['2026-08-07']` — the seed row, pre-dating the v3.4 round-trip fix |
| `unprotected` | **PASS** | zero unprotected positions across all 36 sessions |
| `breaches` | **PASS** | zero money-moving rule breaches |
| `rule16_meltup` | **FAIL** | 2 shallow melt-up rotations — both 2026-08-07, pre-dating the guard |
| `deployment` | **FAIL** | `2026-08-11: 3 consecutive sessions below the 75.0% floor` — and the current run is far worse: **20 consecutive sessions**, ending at 16.33% |

**`deployment` diagnostics (required when it FAILs):** trial window `rule5_triggers: 22`, `rule5_acted: 4`. This is the **`triggers > 0, acted == 0`-shaped** failure — the relaxation arms and the screens still admit almost nothing (4 actions in 22 armings; **0 in the last 22 sessions**). Rule 5 itself is firing correctly; the idea supply downstream of it is the defect. Neither number changes the verdict. `sessions_in_band: 9 of 36`.

**Divergence note.** The weekly and trial verdicts agree (both FAIL) but on **different criteria**: the week fails only `deployment`, while the trial window additionally fails `rule14_accuracy` and `rule16_meltup` on the two seed rows. That is the window-boundary seam working as documented — the seed pair is invisible to any weekly window and visible to every trial-window run. **The trial-window verdict stands.**

**Diagnostic (NOT the verdict, and it does not change it):** `scorecard --since 2026-08-10` — the first session after the seed pair, i.e. the first day both the Rule 16 melt-up guard and the Rule 14 round-trip fix were live — returns **FAIL** across 34 sessions, PASSing `rule14_accuracy` and `rule16_meltup` and failing **only** `deployment` (`2026-08-12: 3 consecutive sessions below the floor`). Stated plainly so this is not read as gaming the window: **correcting `trial_start` would not change the verdict.** The headline stays FAIL under every window tested.

**Caveat on the two PASSing count-criteria — the scorecard cannot see a session that never wrote a row.** `cadence` (144/144) and `rule14_tokens` (72/72) derive both numerator *and* denominator from `METRICS.jsonl`. The Sep 23 `daily-summary` failure removed that session's row entirely, so its 4 routine slots and 2 audit tokens are absent from **both** sides of each ratio and the criteria report a clean PASS for a window containing a confirmed dropped routine. The underlying facts are good — TRADE-LOG.md carries all 10 of this week's audit tokens, including both Sep 23 ones — but **these two PASSes are currently unfalsifiable by the exact failure they are meant to catch**, and should be read that way until Proposed change (1) is applied.

**`alpha_informational` (NOT a gate):** trial window `cum_alpha_pp −2.3619`, `cum_cash_drag_pp −1.2485`, `cum_selection_alpha_pp −1.1134` over 36 sessions. Both components negative and roughly equal — the trial is behind SPY by ~2.4pp, about half from being uninvested and about half from what was owned. Recorded, not gating; 36 sessions still cannot separate this from noise.

**Satellite-sleeve check (v3):** **not triggered.** Per-capital by week — W20: core −0.77% / satellite −2.74% (satellite under) · W21: core −1.86% / satellite +5.13% (satellite over) · W22: core −7.47% / satellite −0.30% (satellite over, on both the 5-session and held-session bases). No 3-week run of satellite underperformance. No allocation-shrink proposal is owed. *(Noted for next week: with `CORE_MV = $0.00` the comparison degenerates — there is no core sleeve left to compare against, which is itself the subject of proposal (2).)*

## Proposed strategy changes (NOT auto-applied — human review required)

- **Rule 5 / pre-market screen (proposed change — carried forward from W20 and W21, unchanged):** when the re-deployment trigger has been armed for **3+ consecutive sessions with `rule5.acted: false` on each**, widen the pre-market's screened universe for `tier: core` candidates only — add the remaining S&P sector SPDRs and the broad-market ETFs (SPY, RSP, IWM) to the core candidate list.
- **Rationale:** unchanged and now at its strongest — the binding constraint is idea *supply*, not the threshold. The trigger armed on 4 of 4 scored sessions and acted on none, for a **22nd consecutive armed-and-unspent session**, while deployment fell to a phase low of 16.33%.
- **Evidence:** `metrics.py rollup --since 2026-09-21` → `rule5_triggers: 4, rule5_acted: 0`; trial window `rule5_triggers: 22, rule5_acted: 4`, `sessions_in_band: 9` of 36; **twenty consecutive sessions below the 75% floor** (2026-08-31 → 2026-09-25); zero buys in a second consecutive week with 5 of 5 weekly-cap slots free; RESEARCH-LOG 2026-09-23/24/25 recording XLK refused at 0.14:1, 0.25:1 and 0.67:1 on consecutive sessions at the narrowest admissible stop.

- **Core floor ≥45% (proposed change — NEW, and the most urgent item in this review):** add a bootstrap exemption — when `CORE_MV == 0`, suspend the satellite core-floor gate for a single `tier: core` **or** `tier: satellite` entry, whichever passes first, sized normally. Equivalently, state the floor as `CORE_MV / (LMV + S) ≥ 0.45 **or** CORE_MV == 0 and this is the book's first fill since core went empty`.
- **Rationale:** at `CORE_MV = 0` the gate as written has no solution for any positive clip, so it does not constrain the core ratio — it forbids the entire buy side unconditionally, including the very core buy that would restore the ratio it protects. A floor that cannot be climbed back to is a trapdoor, not a floor.
- **Evidence:** TRADE-LOG `2026-09-22 — TRADE: XLE side=sell qty=25` takes `CORE_MV` to $0.00; RESEARCH-LOG 2026-09-23 Decision block 1 states it arithmetically — "`0 / (1675.30 + S) ≥ 0.45` has **no solution for any `S > 0`**. Eight single stocks were screened; five pass `rscreen`; **none was reachable at any size or any R:R**"; RESEARCH-LOG 2026-09-24 and 2026-09-25 Decisions both record "none is purchasable at any size while `CORE_MV = $0.00`". Three consecutive sessions in which passing ideas existed and were unreachable by arithmetic alone.

- **`metrics.py` scorecard `cadence` / `rule14_tokens` denominator (proposed change — NEW):** derive the expected-session list for both criteria from a **trading calendar** over `[since, date]`, not from the rows present in `METRICS.jsonl`. A calendar session with no row should count as `4` expected routine slots and `2` expected audit tokens, all **missing** — i.e. it should FAIL the criteria, not silently shrink them.
- **Rationale:** both criteria currently take numerator and denominator from the same file, so the one failure they exist to detect — a routine dying before it writes its metrics row — removes itself from the measurement and reports PASS. This is the identical missing-detector shape that let the original Rule 14 fail-open survive fourteen weeks, and it is now demonstrated live rather than hypothesised.
- **Evidence:** `scorecard --since 2026-09-21` returns `cadence PASS 16/16` and `rule14_tokens PASS 8/8` for a week in which `daily-summary` provably did not run on 2026-09-23 (TRADE-LOG line 4352 `MISSING ROUTINE: daily-summary (Rule 18)`, Telegram URGENT message_id 278, no Sep 23 EOD snapshot). The true denominators for the week are 20 slots and 10 tokens.

- **PROJECT-CONTEXT `trial_start` (proposed change — carried forward from W20 and W21, unchanged):** set `trial_start: 2026-08-10` in `memory/PROJECT-CONTEXT.md`, replacing the `UNSET` placeholder. 2026-08-10 is the first session after the 2026-08-06/07 seed pair — the first trading day on which the Rule 16 melt-up guard and the Rule 14 round-trip fix were both live.
- **Rationale:** the placeholder has now reached the go-live scorecard unset for **eight** consecutive weekly reviews and costs two false FAILs every week, both attributable in full to the single 2026-08-07 row.
- **Evidence:** trial-window scorecard `--since 2026-08-06` FAILs `rule14_accuracy` (`inaccurate on ['2026-08-07']`) and `rule16_meltup` (2 shallow rotations, both 2026-08-07); diagnostic `--since 2026-08-10` PASSes both across 34 sessions. **Stated plainly so this is not read as gaming the window: the correction does NOT change the verdict.** `deployment` FAILs under both windows and the headline stays FAIL. The proposal is worth making because it makes the scorecard report current behaviour truthfully, not because it improves the outcome.

- **Rule 9 (proposed change — carried forward from W20 and W21, unchanged):** add a bounded exception — when a position's trailing stop sits **within 3% of the current price** (Rule 9's own stated minimum distance) **and** the Rule 8 ladder's target trail for the position's current rung is *looser* than the standing trail, permit a one-time widening to the ladder's target trail, capped at the ladder value and logged as a `STOP RELAXED` row with the triggering rung. Never permit widening for any other reason.
- **Rationale:** Rule 9 currently forbids the only remedy for a stop it has itself locked beneath its own minimum-distance floor, converting a protected position into an unmanageable one.
- **Evidence:** TRADE-LOG `2026-09-09 — TRADE: XLB side=sell qty=27` (stop-fill at $51.59 on a 4.1% trail, booking +3.02% against a +4.73% unrealized). *(No new instance this week — no stop was changed at all; GILD's room to stop ranged 3.81%–4.98%, never breaching the floor. The proposal stands on the XLB evidence.)*

- **TRADING_MODE (proposed change — carried forward, eighth weekly review):** set `TRADING_MODE=paper` explicitly in the routine UI environment.
- **Rationale:** the guard's *default* clause, not an explicit value, remains the only thing between an unset variable and a halt. It is the one free prerequisite before any live switch and the longest-standing open item in the log.
- **Evidence:** every market-open / midday / daily-summary row this week records `TRADING_MODE unset → defaults to paper`; the log's counter reads **sixty-first consecutive session on the unset default** as of Thursday's midday. Carried in W15–W21 and again here without action.

- **Logging (proposed change — NEW, minor):** require `daily-summary` to write a `### <date> — TRADE: <SYM> side=sell qty=<n>` header row for any fill it discovers in `activities` that no routine placed (i.e. an unattended GTC stop-out), not prose in the EOD snapshot alone.
- **Rationale:** Rule 10's sector-kill scan and the weekly close-trade audit are both header-anchored, so an unattended stop-out is currently invisible to them even when fully documented.
- **Evidence:** MPC's 2026-09-21 stop-out (+$26.51, Energy WIN) has no header row; TRADE-LOG 2026-09-22 midday already flags this as non-blocking, and Rule 10's Energy tally had to be reasoned around it by hand on Sep 22, 24 and 25.

### Overall Grade: D

Negative alpha of −1.78pp against a tape that rose 1.27%, a routine slot that did not run, deployment at a phase low of 16.33% on a twentieth consecutive below-floor session, and an ETF core sleeve at **zero** that has arithmetically locked the entire buy side shut since Wednesday. The two sells were textbook and the safety rules were immaculate — zero unprotected positions, zero breaches, 22 straight weeks at zero day trades, every audit token present — which is what keeps this off an F. But the grade has to reflect what the portfolio *is*, not how cleanly it was administered: an 84%-cash book with one name in it, no legal path to buying a second, and a scorecard whose two cleanest PASSes turn out to be blind to the one failure that actually happened this week. W21's B− was awarded to a strategy that wasn't running; this week it can't run.
