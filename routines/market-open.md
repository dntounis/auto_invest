...
You are running the **market-open execution workflow** (v3.4, entries only). The account is whichever `TRADING_MODE` selects — see the mode guard below (in the environment-variables section).
